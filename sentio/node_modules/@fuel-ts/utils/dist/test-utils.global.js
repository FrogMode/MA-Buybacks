...
If you are attempting to transform a hex value, please make sure it is being passed as a string and wrapped in quotes.`;
  ...
  // src/test-utils/getForcProject.ts
  var getProjectBuildDir = /* @__PURE__ */ __name((params) => (0, import_path.join)(params.projectDir, "out", params.build), "getProjectBuildDir");
  var getProjectReleaseDir = /* @__PURE__ */ __name((params) => (0, import_path.join)(params.projectDir, "out", params.build), "getProjectReleaseDir");
  var getProjectTempDir = /* @__PURE__ */ __name((params) => (0, import_path.join)(getProjectBuildDir(params), "__temp__"), "getProjectTempDir");
  var getProjectAbiPath = /* @__PURE__ */ __name((params) => (0, import_path.join)(getProjectBuildDir(params), `${params.projectName}-abi.json`), "getProjectAbiPath");
  var getProjectBinPath = /* @__PURE__ */ __name((params) => (0, import_path.join)(getProjectBuildDir(params), `${params.projectName}.bin`), "getProjectBinPath");
  var getProjectStorageSlotsPath = /* @__PURE__ */ __name((params) => (0, import_path.join)(getProjectBuildDir(params), `${params.projectName}-storage_slots.json`), "getProjectStorageSlotsPath");
  var getProjectAbiName = /* @__PURE__ */ __name((params) => `${params.projectName}-abi`, "getProjectAbiName");
  var getProjectNormalizedName = /* @__PURE__ */ __name((params) => normalizeString(params.projectName), "getProjectNormalizedName");
  var getProjectAbi = /* @__PURE__ */ __name((params) => {
    const projectPath = getProjectAbiPath(params);
    const abiContents = JSON.parse((0, import_fs.readFileSync)(projectPath, "utf-8"));
    return abiContents;
  }, "getProjectAbi");
  var getProjectStorageSlots = /* @__PURE__ */ __name((params) => {
  ...
  var getForcProject = /* @__PURE__ */ __name((params) => {
  ...
  var expectToBeInRange = /* @__PURE__ */ __name((params) => {
    const { value, min, max: max2 } = params;
    if (value >= min && value <= max2) {
      return true;
    }
    throw new FuelError(
      FuelError.CODES.INVALID_INPUT_PARAMETERS,
      `Expected value: '${value}' to be within range: '${min}-${max2}'`
    );
  }, "expectToBeInRange");
  ...
  __name(waitUntilUnreachable, "waitUntilUnreachable");

  // src/test-utils/vitest.matchers.ts
  var setupTestMatchers = /* @__PURE__ */ __name((expect) => {
    expect.extend({
      toEqualBn(received, expected) {
        ...
        if (pass) {
          return {
            pass,
            message: /* @__PURE__ */ __name(() => `Expected ${actualBn} not to equal ${expectedBn}`, "message"),
            actual: actualBn
          };
        }
        return {
          pass,
          message: /* @__PURE__ */ __name(() => `Expected ${actualBn} to equal ${expectedBn}`, "message"),
          actual: expectedBn
        };
      }
    });
