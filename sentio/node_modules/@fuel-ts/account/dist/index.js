...
__export(src_exports, {
  ...
  TransactionType: () => import_transactions9.TransactionType,
  ...
  assembleTransferToContractScript: () => assembleTransferToContractScript,
  assets: () => assets,
  ...
  extractResolvedOutputs: () => extractResolvedOutputs,
  ...
  rawAssets: () => rawAssets,
  resolveAccountForAssembleTxParams: () => resolveAccountForAssembleTxParams,
...
var resolveAccountForAssembleTxParams = /* @__PURE__ */ __name((account) => {
  ...
  if (accountIsPredicate) {
    assembleTxAccount.predicate = {
      predicate: (0, import_utils3.hexlify)(account.bytes),
      predicateAddress: account.address.toB256(),
      predicateData: (0, import_utils3.hexlify)(account.getPredicateData())
    };
  } else {
...
var setAndValidateGasAndFeeForAssembledTx = /* @__PURE__ */ __name(async (params) => {
  ...
  const gasLimitSpecified = (0, import_utils3.isDefined)(setGasLimit);
  const maxFeeSpecified = (0, import_utils3.isDefined)(setMaxFee);
  ...
  if (gasLimitSpecified && isScriptTx) {
    ...
    if ((0, import_math2.bn)(setGasLimit).lt((0, import_math2.bn)(requiredGasLimit))) {
      throw new import_errors.FuelError(
        import_errors.ErrorCode.GAS_LIMIT_TOO_LOW,
        `Gas limit '${setGasLimit}' is lower than the required: '${requiredGasLimit}'.`
      );
    }
    transactionRequest.gasLimit = (0, import_math2.bn)(setGasLimit);
  }
  if (maxFeeSpecified) {
    const requiredMaxFee = transactionRequest.maxFee;
    if ((0, import_math2.bn)(setMaxFee).lt(requiredMaxFee)) {
      throw new import_errors.FuelError(
        import_errors.ErrorCode.MAX_FEE_TOO_LOW,
        `Max fee '${setMaxFee}' is lower than the required: '${requiredMaxFee}'.`
      );
    }
    transactionRequest.maxFee = (0, import_math2.bn)(setMaxFee);
  }
...
For the following asset ID: '${assetId}'.` : "";
  ...
  if (gqlErrorMessage.MULTIPLE_CHANGE_POLICIES.test(error.message)) {
    ...
    return new import_errors2.FuelError(
      import_errors2.ErrorCode.CHANGE_OUTPUT_COLLISION,
  ...
  if (gqlErrorMessage.DUPLICATE_CHANGE_OUTPUT_ACCOUNT.test(error.message)) {
    return new import_errors2.FuelError(
      import_errors2.ErrorCode.DUPLICATE_CHANGE_OUTPUT_ACCOUNT,
  ...
  if (gqlErrorMessage.RPC_CONSISTENCY.test(error.message)) {
    return new import_errors2.FuelError(import_errors2.ErrorCode.RPC_CONSISTENCY, error.message, {}, error);
  }
  if (gqlErrorMessage.INSUFFICIENT_FEE_AMOUNT.test(error.message)) {
    ...
    return new import_errors2.FuelError(import_errors2.ErrorCode.FUNDS_TOO_LOW, match?.[0] || error.message, {}, error);
  }
  ...
  switch (value.type) {
    case import_transactions2.InputType.Coin: {
      ...
      return {
        ...
        outputIndex: (0, import_math3.toNumber)((0, import_utils4.arrayify)(value.id).slice(import_abi_coder.BYTES_32, import_abi_coder.UTXO_ID_LEN)),
    ...
    case import_transactions2.InputType.Contract: {
      return {
        ...
        txID: (0, import_utils4.hexlify)(value.txID || import_configs.ZeroBytes32),
        outputIndex: 0,
  ...
  switch (type) {
    ...
    case import_transactions3.OutputType.Variable: {
      return {
        ...
        to: (0, import_utils5.hexlify)(value.to || import_configs2.ZeroBytes32),
        amount: (0, import_math4.bn)(value.amount),
        assetId: (0, import_utils5.hexlify)(value.assetId || import_configs2.ZeroBytes32)
      };
    }
  ...
  switch (input.type) {
    case "InputCoin":
      parsedInput = {
        ...
        id: input.utxoId,
        amount: (0, import_math5.bn)(input.amount),
        ...
        predicateGasUsed: (0, import_math5.bn)(input.predicateGasUsed)
      };
      break;
    case "InputMessage":
      parsedInput = {
    ...
    case "InputContract":
      parsedInput = {
        ...
        txPointer: `0x${input.txPointer}`,
        txID: (0, import_utils6.hexlify)((0, import_utils6.arrayify)(input.utxoId).slice(0, 32))
      };
      break;
    default:
      (0, import_utils6.assertUnreachable)(input);
  }
  return parsedInput;
}, "deserializeInput");
  ...
  switch (output.type) {
    case "CoinOutput":
      parsedOutput = {
        ...
        amount: (0, import_math5.bn)(output.amount),
    ...
    case "VariableOutput":
      ...
      break;
    default:
      (0, import_utils6.assertUnreachable)(output);
  }
  return parsedOutput;
}, "deserializeOutput");
...
var isRequestInputMessageWithoutData = /* @__PURE__ */ __name((input) => input.type === import_transactions8.InputType.Message && (0, import_math8.bn)(input.data).isZero(), "isRequestInputMessageWithoutData");
...
var BaseTransactionRequest = class _BaseTransactionRequest {
  ...
  static getPolicyMeta(req) {
    ...
    if ((0, import_math9.bn)(tip).gt(0)) {
      ...
      policies.push({ data: (0, import_math9.bn)(tip), type: import_transactions9.PolicyType.Tip });
    }
    if ((0, import_utils11.isDefined)(witnessLimit) && (0, import_math9.bn)(witnessLimit).gte(0)) {
      ...
      policies.push({ data: (0, import_math9.bn)(witnessLimit), type: import_transactions9.PolicyType.WitnessLimit });
    }
    ...
    if ((0, import_utils11.isDefined)(req.ownerInputIndex)) {
      policyTypes += import_transactions9.PolicyType.Owner;
      policies.push({ data: (0, import_math9.bn)(req.ownerInputIndex), type: import_transactions9.PolicyType.Owner });
    }
    return {
      policyTypes,
      policies
  ...
  fundWithFakeUtxos(quantities, baseAssetId, resourcesOwner) {
    ...
    const updateAssetInput = /* @__PURE__ */ __name((assetId, quantity) => {
      ...
      if (assetInput && "assetId" in assetInput) {
        assetInput.id = (0, import_utils11.hexlify)((0, import_crypto.randomBytes)(import_abi_coder2.UTXO_ID_LEN));
        assetInput.amount = usedQuantity;
      } else {
        this.addResources([
          {
            id: (0, import_utils11.hexlify)((0, import_crypto.randomBytes)(import_abi_coder2.UTXO_ID_LEN)),
            amount: usedQuantity,
            assetId,
...
function hashTransaction(transactionRequest, chainId) {
  ...
  const concatenatedData = (0, import_utils13.concat)([chainIdBytes, new import_transactions10.TransactionCoder().encode(transaction)]);
...
var isTransactionTypeScript = /* @__PURE__ */ __name((request2) => request2.type === import_transactions15.TransactionType.Script, "isTransactionTypeScript");
var isTransactionTypeCreate = /* @__PURE__ */ __name((request2) => request2.type === import_transactions15.TransactionType.Create, "isTransactionTypeCreate");
var isTransactionTypeBlob = /* @__PURE__ */ __name((request2) => request2.type === import_transactions15.TransactionType.Blob, "isTransactionTypeBlob");
var isTransactionTypeUpgrade = /* @__PURE__ */ __name((request2) => request2.type === import_transactions15.TransactionType.Upgrade, "isTransactionTypeUpgrade");
var isTransactionTypeUpload = /* @__PURE__ */ __name((request2) => request2.type === import_transactions15.TransactionType.Upload, "isTransactionTypeUpload");
...
function getOutputsVariable(outputs) {
  return getOutputsByType(outputs, import_transactions18.OutputType.Variable);
}
...
function getReceiptsTransferOut(receipts) {
  return getReceiptsByType(receipts, import_transactions19.ReceiptType.TransferOut);
}
...
function assembleTransactionSummary(params) {
  ...
  const tip = (0, import_math17.bn)(transaction.policies?.find((policy) => policy.type === import_transactions21.PolicyType.Tip)?.data);
...
function getDecodedLogs(receipts, mainAbi, externalAbis = {}) {
  ...
  if (mainAbi.programType === "contract") {
    const firstCallReceipt = receipts.find(
      (r) => r.type === import_transactions24.ReceiptType.Call && r.id === import_configs13.ZeroBytes32
    );
    mainContract = firstCallReceipt.to;
  }
  return receipts.reduce((logs, receipt) => {
    if (receipt.type === import_transactions24.ReceiptType.LogData || receipt.type === import_transactions24.ReceiptType.Log) {
  ...
  async assembleTx(params) {
    ...
    const requiredBalances = accountCoinQuantities.map((quantity, index) => {
      ...
      const requiredBalance = {
        ...
        amount: (0, import_math19.bn)(amount).toString(10),
        assetId,
        changePolicy
      };
    ...
    if (feePayerIndex === -1) {
      ...
      const newLength = requiredBalances.push({
        ...
        amount: (0, import_math19.bn)(0).toString(10),
...
async function getTransactionSummary(params) {
  ...
  const gasPrice = totalFee ? (0, import_math20.bn)(0) : await provider.getLatestGasPrice();
...
var assembleTransactionSummaryFromJson = /* @__PURE__ */ __name(async (opts) => {
  ...
  return assembleTransactionSummary({
    ...
    gasPrice: (0, import_math21.bn)(gasPrice),
    // From chain
    baseAssetId,
    maxInputs,
    gasCosts,
