...
export type GqlQuery = {
    ...
    assetDetails?: Maybe<GqlAssetInfoDetails>;
    balance: GqlBalance;
...
export type GqlReceipt = {
    ...
    subId?: Maybe<Scalars['SubId']['output']>;
...
export type GqlSubscription = {
    alpha__new_blocks: Scalars['HexString']['output'];
    alpha__preconfirmations: GqlTransactionStatus;
