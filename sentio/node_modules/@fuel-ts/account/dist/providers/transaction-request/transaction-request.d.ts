...
export declare abstract class BaseTransactionRequest implements BaseTransactionRequestLike {
     ...
     */
    constructor({ tip, maturity, expiration, ownerInputIndex, maxFee, witnessLimit, inputs, outputs, witnesses, flag, }?: BaseTransactionRequestLike);
     ...
     */
    updateState(chainId: number, state?: TransactionStateFlag['state'], summary?: TransactionSummaryJsonPartial): void;
}
