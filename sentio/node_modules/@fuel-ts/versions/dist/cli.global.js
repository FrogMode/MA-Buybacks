...
(() => {
  ...
  var colorizeUserVersion = /* @__PURE__ */ __name((params) => {
  ...
  var getSystemVersion = /* @__PURE__ */ __name((command) => {
    let version = null;
    let error = null;
    try {
  ...
  var getBinaryVersions = /* @__PURE__ */ __name((params = {}) => {
  ...
  // src/cli.ts
  var eitherOr = /* @__PURE__ */ __name((val1, val2) => val1 ?? val2, "eitherOr");
