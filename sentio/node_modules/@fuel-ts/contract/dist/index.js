...
var hexlifyWithPrefix = /* @__PURE__ */ __name((value) => (0, import_utils3.hexlify)(value.startsWith("0x") ? value : `0x${value}`), "hexlifyWithPrefix");
...
var ContractFactory = class _ContractFactory {
  ...
  async assembleTx(request, options = {}) {
    ...
    request.maxFee = (0, import_math.bn)(0);
    const { gasPrice, assembledRequest } = await account.provider.assembleTx({
      request,
      feePayerAccount: account,
      accountCoinQuantities: []
    });
    request = await (0, import_account.setAndValidateGasAndFeeForAssembledTx)({
      gasPrice,
