...
If you are attempting to transform a hex value, please make sure it is being passed as a string and wrapped in quotes.`;
  ...
  var concatBytes = /* @__PURE__ */ __name5((arrays) => {
  ...
  var concat = /* @__PURE__ */ __name5((arrays) => {
  ...
  // ../../node_modules/.pnpm/@noble+hashes@1.7.1/node_modules/@noble/hashes/esm/scrypt.js
  ...
  var scrypt2 = /* @__PURE__ */ __name6((params) => {
    const { password, salt, n, p, r, dklen } = params;
    const derivedKey = scrypt(password, salt, { N: n, r, p, dkLen: dklen });
    return derivedKey;
  }, "scrypt");
  var keccak256 = /* @__PURE__ */ __name6((data) => keccak_256(data), "keccak256");
  function ripemd1602(_data) {
    const data = arrayify(_data, "data");
    return ripemd160(data);
  }
  __name(ripemd1602, "ripemd160");
  __name6(ripemd1602, "ripemd160");
  var bufferFromString = /* @__PURE__ */ __name6((string, encoding = "base64") => Uint8Array.from(Buffer.from(string, encoding)), "bufferFromString");
  ...
  __name6(pbkdf22, "pbkdf2");
  var randomBytes = /* @__PURE__ */ __name6((length) => {
    const randomValues = Uint8Array.from(import_crypto3.default.randomBytes(length));
    return randomValues;
  }, "randomBytes");
  var stringFromBuffer = /* @__PURE__ */ __name6((buffer, encoding = "base64") => Buffer.from(buffer).toString(encoding), "stringFromBuffer");
  var ALGORITHM = "aes-256-ctr";
  var keyFromPassword = /* @__PURE__ */ __name6((password, saltBuffer) => {
    const passBuffer = bufferFromString(String(password).normalize("NFKC"), "utf-8");
    const key = pbkdf22(passBuffer, saltBuffer, 1e5, 32, "sha256");
    return arrayify(key);
  }, "keyFromPassword");
  var encrypt = /* @__PURE__ */ __name6(async (password, data) => {
  ...
  var decrypt = /* @__PURE__ */ __name6(async (password, keystore) => {
  ...
  __name6(encryptJsonWalletData, "encryptJsonWalletData");
  ...
  __name6(decryptJsonWalletData, "decryptJsonWalletData");
  ...
  __name6(computeHmac, "computeHmac");
  var randomUUID = /* @__PURE__ */ __name6(() => (0, import_crypto6.randomUUID)(), "randomUUID");
  var api = {
    bufferFromString,
    stringFromBuffer,
    decrypt,
  ...
  __name7(uint64ToBytesBE, "uint64ToBytesBE");
  function hashMessage(message) {
    if (typeof message === "string") {
      return sha2562(toUtf8Bytes(message));
    }
    ...
    return hexlify(sha2562(payload));
  }
  ...
  WORD_SIZE + // Predicate data size
  WORD_SIZE;
  var isUint8Array = /* @__PURE__ */ __name8((value) => value instanceof Uint8Array, "isUint8Array");
  var hasNestedOption = /* @__PURE__ */ __name8((coders) => {
  ...
  var getLength = /* @__PURE__ */ __name8((baseType) => {
    switch (baseType) {
      case "u8":
        return 1;
      case "u16":
  ...
  var getEncodingVersion = /* @__PURE__ */ __name8((encoding) => {
    switch (encoding) {
      case void 0:
      case ENCODING_V1:
        return ENCODING_V1;
  ...
  var findTypeById = /* @__PURE__ */ __name8((abi, typeId) => {
  ...
  var findNonVoidInputs = /* @__PURE__ */ __name8((abi, inputs) => inputs.filter((input) => findTypeById(abi, input.type).type !== VOID_TYPE), "findNonVoidInputs");
  var findVectorBufferArgument = /* @__PURE__ */ __name8((components) => {
  ...
  var ResolvedAbiType = class _ResolvedAbiType {
    static {
      __name(this, "_ResolvedAbiType");
    }
    static {
      __name8(this, "ResolvedAbiType");
    }
    abi;
    name;
    type;
  ...
  __name8(getCoders, "getCoders");
  var getCoder = /* @__PURE__ */ __name8((resolvedAbiType, _options) => {
  ...
  __name8(getCoderForEncoding, "getCoderForEncoding");
  var AbiCoder = class {
    static {
      __name(this, "AbiCoder");
    }
    static {
      __name8(this, "AbiCoder");
    }
  ...
  var getFunctionInputs = /* @__PURE__ */ __name8((params) => {
  ...
  var padValuesWithUndefined = /* @__PURE__ */ __name8((values, inputs) => {
  ...
  var FunctionFragment = class _FunctionFragment {
    static {
      __name(this, "_FunctionFragment");
    }
    static {
      __name8(this, "FunctionFragment");
    }
    signature;
    selector;
    selectorBytes;
  ...
  var findTypeByConcreteId = /* @__PURE__ */ __name8((types, id) => types.find((x) => x.concreteTypeId === id), "findTypeByConcreteId");
  var findConcreteTypeById = /* @__PURE__ */ __name8((abi, id) => abi.concreteTypes.find((x) => x.concreteTypeId === id), "findConcreteTypeById");
  ...
  __name8(finsertTypeIdByConcreteTypeId, "finsertTypeIdByConcreteTypeId");
  ...
  __name8(parseFunctionTypeArguments, "parseFunctionTypeArguments");
  ...
  __name8(parseConcreteType, "parseConcreteType");
  ...
  __name8(parseComponents, "parseComponents");
  ...
  __name8(transpileAbi, "transpileAbi");
  var Interface = class {
    static {
      __name(this, "Interface");
    }
    static {
      __name8(this, "Interface");
    }
    functions;
    configurables;
    jsonAbi;
      ...
      for (const policyType of policyTypesArray) {
        switch (policyType) {
          ...
          case 32 /* Owner */: {
            ...
            o = nextOffset;
            policies.push({ type: 32 /* Owner */, data: owner });
            break;
          }
          default:
            break;
