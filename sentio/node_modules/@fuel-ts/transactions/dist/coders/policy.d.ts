...
export type Policy = PolicyTip | PolicyWitnessLimit | PolicyMaturity | PolicyMaxFee | PolicyExpiration | PolicyOwner;
...
export declare function getPolicyTypesArray(policyTypes: number): number[];
