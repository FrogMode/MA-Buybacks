...
__export(src_exports, {
  ...
  getPolicyTypesArray: () => getPolicyTypesArray,
...
var InputMessageCoder = class _InputMessageCoder extends import_abi_coder3.Coder {
  static {
  ...
  decode(data, offset, policyTypes) {
    ...
    for (const policyType of policyTypesArray) {
      switch (policyType) {
        ...
        case 16 /* Expiration */: {
          const [expiration, nextOffset] = new import_abi_coder5.NumberCoder("u32", { padToWordSize: true }).decode(
            data,
            o
          );
          o = nextOffset;
        ...
        case 32 /* Owner */: {
          const [owner, nextOffset] = new import_abi_coder5.BigNumberCoder("u64").decode(data, o);
          o = nextOffset;
    ...
    if (leftPolicyTypes > 0) {
      ...
      o += leftPolicyTypes * import_abi_coder5.WORD_SIZE;
    }
    return [policies, o];
  }
};
