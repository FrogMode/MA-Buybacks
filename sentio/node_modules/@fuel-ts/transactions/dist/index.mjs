...
var InputMessageCoder = class _InputMessageCoder extends Coder2 {
  static {
...
import { BigNumberCoder as BigNumberCoder3, Coder as Coder4, NumberCoder as NumberCoder4, WORD_SIZE } from "@fuel-ts/abi-coder";
  ...
  decode(data, offset, policyTypes) {
    ...
    for (const policyType of policyTypesArray) {
      switch (policyType) {
        ...
        case 16 /* Expiration */: {
          const [expiration, nextOffset] = new NumberCoder4("u32", { padToWordSize: true }).decode(
            data,
            o
          );
          o = nextOffset;
        ...
        case 32 /* Owner */: {
          const [owner, nextOffset] = new BigNumberCoder3("u64").decode(data, o);
          o = nextOffset;
