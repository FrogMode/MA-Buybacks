  ...
  var require_lib = __commonJS({
    "../../node_modules/.pnpm/cli-table@0.3.11/node_modules/cli-table/lib/index.js"(exports, module) {
      ...
      Table.prototype.toString = function() {
        ...
        __name(generateRow, "generateRow");
        ;
...
This unreleased fuel-core build may include features and updates not yet supported by this version of the TS-SDK.`);
  ...
  var colorizeUserVersion = /* @__PURE__ */ __name4((params) => {
    const { version, isGt, isOk } = params;
    if (isGt) {
      return import_chalk2.default.cyan(version);
    }
    if (isOk) {
      return import_chalk2.default.green(version);
    }
    return import_chalk2.default.red(version);
  }, "colorizeUserVersion");
  ...
  __name(getBuiltinVersions2, "getBuiltinVersions");
  __name4(getBuiltinVersions2, "getBuiltinVersions");
  function parseVersion2(version) {
    const [major, minor, patch] = version.split(".").map((v) => parseInt(v, 10));
    return { major, minor, patch };
  }
  __name(parseVersion2, "parseVersion");
  __name4(parseVersion2, "parseVersion");
  ...
  __name(versionDiffs2, "versionDiffs");
  __name4(versionDiffs2, "versionDiffs");
  function gt2(version1, version2) {
    const { fullVersionDiff } = versionDiffs2(version1, version2);
    return fullVersionDiff > 0;
  }
  __name(gt2, "gt");
  __name4(gt2, "gt");
  function eq2(version1, version2) {
    const { fullVersionDiff } = versionDiffs2(version1, version2);
    return fullVersionDiff === 0;
  }
  __name(eq2, "eq");
  ...
  __name(compareSystemVersions, "compareSystemVersions");
  __name4(compareSystemVersions, "compareSystemVersions");
  ...
  var getSystemVersion = /* @__PURE__ */ __name4((command) => {
    let version = null;
    let error = null;
    try {
  ...
  __name(getSystemForc, "getSystemForc");
  __name4(getSystemForc, "getSystemForc");
  ...
  __name(getSystemFuelCore, "getSystemFuelCore");
  __name4(getSystemFuelCore, "getSystemFuelCore");
  ...
  __name(getSystemVersions, "getSystemVersions");
  __name4(getSystemVersions, "getSystemVersions");
  var eitherOr = /* @__PURE__ */ __name4((val1, val2) => val1 ?? val2, "eitherOr");
  function runVersions(params = {}) {
    const { error, info } = console;
    const supportedVersions = getBuiltinVersions2();
    const cliTable = new import_cli_table.default({
      head: ["", import_chalk.default.bold("Supported"), import_chalk.default.bold(`Yours / System`), import_chalk.default.bold("System Path")]
    });
    const {
      error: systemError,
      systemForcVersion,
...
You have all the right versions! \u26A1`);
 ...
 - You're using outdated versions`);
    ...
    if (exitCode === 1) {
      error(`  ${import_chalk.default.green(fuelUpLink)}`);
    }
    process.exit(exitCode);
  }
  __name(runVersions, "runVersions");
  __name4(runVersions, "runVersions");
  ...
  var tryFindBinaries = /* @__PURE__ */ __name5((paths = {}) => {
