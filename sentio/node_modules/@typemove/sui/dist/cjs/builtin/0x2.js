...
exports.url = exports.types = exports.tx_context = exports.transfer_policy = exports.transfer = exports.token = exports.table_vec = exports.table = exports.sui = exports.random = exports.priority_queue = exports.poseidon = exports.pay = exports.party = exports.package$ = exports.object_table = exports.object_bag = exports.object$ = exports.nitro_attestation = exports.math = exports.linked_table = exports.kiosk_extension = exports.kiosk = exports.hmac = exports.hex = exports.hash = exports.group_ops = exports.groth16 = exports.event = exports.ed25519 = exports.ecvrf = exports.ecdsa_r1 = exports.ecdsa_k1 = exports.dynamic_object_field = exports.dynamic_field = exports.display = exports.derived_object = exports.deny_list = exports.config = exports.coin = exports.clock = exports.borrow = exports.bls12381 = exports.bcs = exports.balance = exports.bag = exports.authenticator_state = exports.address = exports.accumulator_metadata = exports.accumulator = void 0;
exports.zklogin_verified_issuer = exports.zklogin_verified_id = exports.versioned = exports.vec_set = exports.vec_map = exports.vdf = void 0;
...
(function (accumulator) {
    ...
    (function (AccumulatorRoot) {
        ...
        const TYPE = new move_1.TypeDescriptor(AccumulatorRoot.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (Key) {
        ...
        const TYPE = new move_1.TypeDescriptor(Key.TYPE_QNAME);
    ...
    (function (U128) {
        ...
        const TYPE = new move_1.TypeDescriptor(U128.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        U128.type = type;
    ...
    (function (builder) {
        ...
        function emitDepositEvent(tx, args, typeArguments) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[1], tx));
        ...
        function updateU128(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU128)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
...
})(accumulator || (exports.accumulator = accumulator = {}));
var accumulator_metadata;
(function (accumulator_metadata) {
    let Metadata;
    (function (Metadata) {
        Metadata.TYPE_QNAME = "0x2::accumulator_metadata::Metadata";
        const TYPE = new move_1.TypeDescriptor(Metadata.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        Metadata.type = type;
    ...
    (function (MetadataKey) {
        ...
        const TYPE = new move_1.TypeDescriptor(MetadataKey.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
    ...
    (function (Owner) {
        ...
        const TYPE = new move_1.TypeDescriptor(Owner.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        Owner.type = type;
    ...
    (function (OwnerKey) {
        ...
        const TYPE = new move_1.TypeDescriptor(OwnerKey.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        OwnerKey.type = type;
...
})(accumulator_metadata || (exports.accumulator_metadata = accumulator_metadata = {}));
var address;
(function (address) {
    let builder;
    (function (builder) {
...
(function (coin) {
    ...
    (function (builder) {
        ...
        function createRegulatedCurrencyV2(tx, args, typeArguments) {
            ...
            _args.push((0, sui_3.transactionArgumentOrVec)(args[4], tx));
            _args.push((0, sui_3.transactionArgumentOrPure)(args[5], tx));
            _args.push((0, sui_3.transactionArgumentOrPureBool)(args[6], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function denyListAdd(tx, args, typeArguments) {
            ...
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function migrateRegulatedCurrencyToV2(tx, args, typeArguments) {
            ...
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPure)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrPureBool)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (deny_list) {
    ...
    (function (builder) {
        ...
        function v1Add(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrVec)(args[2], tx));
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (derived_object) {
    ...
    (function (ClaimedStatus) {
        ...
        const TYPE = new move_1.TypeDescriptor(ClaimedStatus.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (Claimed) {
        ...
        const TYPE = new move_1.TypeDescriptor(Claimed.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        Claimed.type = type;
    ...
    (function (DerivedObjectKey) {
        ...
        const TYPE = new move_1.TypeDescriptor(DerivedObjectKey.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
...
})(derived_object || (exports.derived_object = derived_object = {}));
var display;
(function (display) {
    let Display;
    (function (Display) {
...
(function (ecdsa_k1) {
    ...
    (function (builder) {
        ...
        function secp256k1Ecrecover(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU8)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function secp256k1Verify(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrObject)(args[2], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU8)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (group_ops) {
    ...
    (function (builder) {
        ...
        function setAsPrefix(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPureBool)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrObject)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (kiosk) {
    ...
    (function (builder) {
        ...
        function list(tx, args, typeArguments) {
            ...
            _args.push((0, sui_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrPure)(args[2], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (kiosk_extension) {
    ...
    (function (builder) {
        function add(tx, args, typeArguments) {
            ...
            _args.push((0, sui_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrObject)(args[2], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU128)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (nitro_attestation) {
    ...
    (function (NitroAttestationDocument) {
        ...
        const TYPE = new move_1.TypeDescriptor(NitroAttestationDocument.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (PCREntry) {
        ...
        const TYPE = new move_1.TypeDescriptor(PCREntry.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        PCREntry.type = type;
...
})(nitro_attestation || (exports.nitro_attestation = nitro_attestation = {}));
var object$;
(function (object$) {
    let ID;
    (function (ID) {
...
(function (party) {
    ...
    (function (Party) {
        ...
        const TYPE = new move_1.TypeDescriptor(Party.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        Party.type = type;
    ...
    (function (Permissions) {
        ...
        const TYPE = new move_1.TypeDescriptor(Permissions.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (random) {
    ...
    (function (builder) {
        ...
        function generateU16InRange(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU16)(args[1], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU16)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function generateU32InRange(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU32)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (zklogin_verified_id) {
    ...
    (function (builder) {
        ...
        function checkZkloginId(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU256)(args[5], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function verifyZkloginId(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPure)(args[2], tx));
            _args.push((0, sui_3.transactionArgumentOrPure)(args[3], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU256)(args[4], tx));
            // @ts-ignore
            return tx.moveCall({
