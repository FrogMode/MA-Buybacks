...
exports.voting_power = exports.validator_wrapper = exports.validator_set = exports.validator_cap = exports.validator = exports.sui_system_state_inner = exports.sui_system = exports.storage_fund = exports.staking_pool = exports.stake_subsidy = exports.genesis = void 0;
...
(function (stake_subsidy) {
    ...
    (function (StakeSubsidy) {
        ...
        const TYPE = new move_1.TypeDescriptor(StakeSubsidy.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (builder) {
        ...
        function create(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU16)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function getDistributionCounter(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::stake_subsidy::get_distribution_counter",
                arguments: _args,
            });
        }
        builder.getDistributionCounter = getDistributionCounter;
    ...
    (function (view) {
        ...
        async function getDistributionCounter(client, args) {
            const tx = new transactions_1.Transaction();
        ...
        view.getDistributionCounter = getDistributionCounter;
...
(function (staking_pool) {
    ...
    (function (StakedSui) {
        ...
        const TYPE = new move_1.TypeDescriptor(StakedSui.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        StakedSui.type = type;
    ...
    (function (StakingPool) {
        ...
        const TYPE = new move_1.TypeDescriptor(StakingPool.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        StakingPool.type = type;
    })(StakingPool = staking_pool.StakingPool || (staking_pool.StakingPool = {}));
    let UnderflowSuiBalance;
    (function (UnderflowSuiBalance) {
        UnderflowSuiBalance.TYPE_QNAME = "0x3::staking_pool::UnderflowSuiBalance";
        const TYPE = new move_1.TypeDescriptor(UnderflowSuiBalance.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        UnderflowSuiBalance.type = type;
    })(UnderflowSuiBalance = staking_pool.UnderflowSuiBalance || (staking_pool.UnderflowSuiBalance = {}));
    let builder;
    (function (builder) {
        ...
        function activationEpoch(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::staking_pool::activation_epoch",
                arguments: _args,
            });
        }
        builder.activationEpoch = activationEpoch;
        function calculateRewards(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::staking_pool::calculate_rewards",
                arguments: _args,
            });
        }
        builder.calculateRewards = calculateRewards;
    ...
    (function (view) {
        ...
        async function activationEpoch(client, args) {
            const tx = new transactions_1.Transaction();
            builder.activationEpoch(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.activationEpoch = activationEpoch;
        async function calculateRewards(client, args) {
            const tx = new transactions_1.Transaction();
            builder.calculateRewards(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.calculateRewards = calculateRewards;
...
(function (storage_fund) {
    ...
    (function (StorageFund) {
        ...
        const TYPE = new move_1.TypeDescriptor(StorageFund.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (builder) {
        function advanceEpoch(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[4], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[5], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (sui_system) {
    ...
    (function (SuiSystemState) {
        ...
        const TYPE = new move_1.TypeDescriptor(SuiSystemState.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (builder) {
        ...
        function activeValidatorAddressesRef(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::sui_system::active_validator_addresses_ref",
                arguments: _args,
            });
        }
        builder.activeValidatorAddressesRef = activeValidatorAddressesRef;
        function activeValidatorVotingPowers(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::sui_system::active_validator_voting_powers",
                arguments: _args,
            });
        }
        ...
        function calculateRewards(tx, args) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::sui_system::calculate_rewards",
                arguments: _args,
            });
        }
        builder.calculateRewards = calculateRewards;
        ...
        function requestAddValidatorCandidate(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[13], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[14], tx));
            // @ts-ignore
            return tx.moveCall({
    ...
    (function (view) {
        ...
        async function activeValidatorAddressesRef(client, args) {
            const tx = new transactions_1.Transaction();
            builder.activeValidatorAddressesRef(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.activeValidatorAddressesRef = activeValidatorAddressesRef;
...
(function (sui_system_state_inner) {
    ...
    (function (SuiSystemStateInner) {
        ...
        const TYPE = new move_1.TypeDescriptor(SuiSystemStateInner.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (SuiSystemStateInnerV2) {
        ...
        const TYPE = new move_1.TypeDescriptor(SuiSystemStateInnerV2.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (SystemEpochInfoEvent) {
        ...
        const TYPE = new move_1.TypeDescriptor(SystemEpochInfoEvent.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (SystemParameters) {
        ...
        const TYPE = new move_1.TypeDescriptor(SystemParameters.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (SystemParametersV2) {
        ...
        const TYPE = new move_1.TypeDescriptor(SystemParametersV2.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (builder) {
        ...
        function advanceEpoch(tx, args) {
            ...
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[5], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[6], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[7], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[8], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[9], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        builder.setCandidateValidatorGasPrice = setCandidateValidatorGasPrice;
        function storeExecutionTimeEstimates(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrVec)(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::sui_system_state_inner::store_execution_time_estimates",
                arguments: _args,
            });
        }
        builder.storeExecutionTimeEstimates = storeExecutionTimeEstimates;
        ...
        function validators(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::sui_system_state_inner::validators",
                arguments: _args,
            });
        }
        builder.validators = validators;
        function validatorsMut(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::sui_system_state_inner::validators_mut",
                arguments: _args,
            });
        }
        builder.validatorsMut = validatorsMut;
    ...
    (function (view) {
        ...
        view.setCandidateValidatorGasPrice = setCandidateValidatorGasPrice;
        async function storeExecutionTimeEstimates(client, args) {
            const tx = new transactions_1.Transaction();
            builder.storeExecutionTimeEstimates(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.storeExecutionTimeEstimates = storeExecutionTimeEstimates;
        ...
        async function validators(client, args) {
            const tx = new transactions_1.Transaction();
            builder.validators(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        async function validatorsMut(client, args) {
            const tx = new transactions_1.Transaction();
            builder.validatorsMut(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.validatorsMut = validatorsMut;
...
(function (validator_cap) {
    ...
    let builder;
    (function (builder) {
        function intoVerified(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::validator_cap::into_verified",
                arguments: _args,
            });
        }
        builder.intoVerified = intoVerified;
        function newUnverifiedValidatorOperationCapAndTransfer(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[0], tx));
            // @ts-ignore
    ...
    let view;
    (function (view) {
        async function intoVerified(client, args) {
            const tx = new transactions_1.Transaction();
            builder.intoVerified(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.intoVerified = intoVerified;
        async function newUnverifiedValidatorOperationCapAndTransfer(client, args) {
            const tx = new transactions_1.Transaction();
            builder.newUnverifiedValidatorOperationCapAndTransfer(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
...
(function (validator_set) {
    ...
    (function (ValidatorEpochInfoEvent) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorEpochInfoEvent.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorEpochInfoEventV2) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorEpochInfoEventV2.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorSet) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorSet.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        ValidatorSet.type = type;
    })(ValidatorSet = validator_set.ValidatorSet || (validator_set.ValidatorSet = {}));
    let VotingPowerAdmissionStartEpochKey;
    (function (VotingPowerAdmissionStartEpochKey) {
        VotingPowerAdmissionStartEpochKey.TYPE_QNAME = "0x3::validator_set::VotingPowerAdmissionStartEpochKey";
        const TYPE = new move_1.TypeDescriptor(VotingPowerAdmissionStartEpochKey.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        VotingPowerAdmissionStartEpochKey.type = type;
    })(VotingPowerAdmissionStartEpochKey = validator_set.VotingPowerAdmissionStartEpochKey || (validator_set.VotingPowerAdmissionStartEpochKey = {}));
    let builder;
    (function (builder) {
        function activeValidatorAddresses(tx, args) {
            const _args = [];
        ...
        function calculateTotalStakes(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::validator_set::calculate_total_stakes",
                arguments: _args,
            });
        }
        builder.calculateTotalStakes = calculateTotalStakes;
        function convertToFungibleStakedSui(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPure)(args[1], tx));
        ...
        function isActiveValidator(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::validator_set::is_active_validator",
                arguments: _args,
            });
        }
        builder.isActiveValidator = isActiveValidator;
        ...
        function isAtRiskValidator(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::validator_set::is_at_risk_validator",
                arguments: _args,
            });
        }
        builder.isAtRiskValidator = isAtRiskValidator;
        ...
        builder.validatorAddressByPoolId = validatorAddressByPoolId;
        function validatorByPoolId(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrObject)(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::validator_set::validator_by_pool_id",
                arguments: _args,
            });
        }
        builder.validatorByPoolId = validatorByPoolId;
        function validatorStakeAmount(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPureAddress)(args[1], tx));
    ...
    (function (view) {
        ...
        async function calculateTotalStakes(client, args) {
            const tx = new transactions_1.Transaction();
            builder.calculateTotalStakes(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.calculateTotalStakes = calculateTotalStakes;
        async function convertToFungibleStakedSui(client, args) {
            const tx = new transactions_1.Transaction();
            builder.convertToFungibleStakedSui(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
        ...
        async function isActiveValidator(client, args) {
            const tx = new transactions_1.Transaction();
            builder.isActiveValidator(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.isActiveValidator = isActiveValidator;
        ...
        async function isAtRiskValidator(client, args) {
            const tx = new transactions_1.Transaction();
            builder.isAtRiskValidator(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.isAtRiskValidator = isAtRiskValidator;
        ...
        view.validatorAddressByPoolId = validatorAddressByPoolId;
        async function validatorByPoolId(client, args) {
            const tx = new transactions_1.Transaction();
            builder.validatorByPoolId(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.validatorByPoolId = validatorByPoolId;
        async function validatorStakeAmount(client, args) {
            const tx = new transactions_1.Transaction();
            builder.validatorStakeAmount(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
...
(function (validator_wrapper) {
    ...
    (function (ValidatorWrapper) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorWrapper.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (voting_power) {
    ...
    (function (VotingPowerInfo) {
        ...
        const TYPE = new move_1.TypeDescriptor(VotingPowerInfo.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (VotingPowerInfoV2) {
        ...
        const TYPE = new move_1.TypeDescriptor(VotingPowerInfoV2.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    let builder;
    (function (builder) {
        function deriveRawVotingPower(tx, args) {
            const _args = [];
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[0], tx));
            _args.push((0, sui_3.transactionArgumentOrPureU64)(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x3::voting_power::derive_raw_voting_power",
                arguments: _args,
            });
        }
        builder.deriveRawVotingPower = deriveRawVotingPower;
    ...
    let view;
    (function (view) {
        async function deriveRawVotingPower(client, args) {
            const tx = new transactions_1.Transaction();
            builder.deriveRawVotingPower(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: sui_2.ZERO_ADDRESS,
            });
        ...
        view.deriveRawVotingPower = deriveRawVotingPower;
