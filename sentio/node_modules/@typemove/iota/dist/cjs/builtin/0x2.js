...
exports.vec_map = exports.vdf = exports.url = exports.types = exports.tx_context = exports.transfer_policy = exports.transfer = exports.token = exports.timelock = exports.table_vec = exports.table = exports.system_admin_cap = exports.random = exports.priority_queue = exports.poseidon = exports.pay = exports.package$ = exports.object_table = exports.object_bag = exports.object$ = exports.linked_table = exports.labeler = exports.kiosk_extension = exports.kiosk = exports.iota = exports.hmac = exports.hex = exports.hash = exports.group_ops = exports.groth16 = exports.event = exports.ed25519 = exports.ecvrf = exports.ecdsa_r1 = exports.ecdsa_k1 = exports.dynamic_object_field = exports.dynamic_field = exports.display = exports.deny_list = exports.config = exports.coin_manager = exports.coin = exports.clock = exports.borrow = exports.bls12381 = exports.bcs = exports.balance = exports.bag = exports.authenticator_state = exports.address = void 0;
exports.zklogin_verified_issuer = exports.zklogin_verified_id = exports.versioned = exports.vec_set = void 0;
...
(function (bls12381) {
    ...
    (function (UncompressedG1) {
        ...
        const TYPE = new move_1.TypeDescriptor(UncompressedG1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (coin) {
    ...
    (function (DenyCapV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(DenyCapV1.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        DenyCapV1.type = type;
    ...
    (function (builder) {
        ...
        function createRegulatedCurrencyV1(tx, args, typeArguments) {
            ...
            _args.push((0, iota_3.transactionArgumentOrVec)(args[4], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[5], tx));
            _args.push((0, iota_3.transactionArgumentOrPureBool)(args[6], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (coin_manager) {
    ...
    (function (CoinManaged) {
        ...
        const TYPE = new move_1.TypeDescriptor(CoinManaged.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (CoinManager) {
        ...
        const TYPE = new move_1.TypeDescriptor(CoinManager.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
    ...
    (function (CoinManagerMetadataCap) {
        ...
        const TYPE = new move_1.TypeDescriptor(CoinManagerMetadataCap.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
    ...
    (function (CoinManagerTreasuryCap) {
        ...
        const TYPE = new move_1.TypeDescriptor(CoinManagerTreasuryCap.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
    ...
    (function (ImmutableCoinMetadata) {
        ...
        const TYPE = new move_1.TypeDescriptor(ImmutableCoinMetadata.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
    ...
    (function (MetadataOwnershipRenounced) {
        ...
        const TYPE = new move_1.TypeDescriptor(MetadataOwnershipRenounced.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (TreasuryOwnershipRenounced) {
        ...
        const TYPE = new move_1.TypeDescriptor(TreasuryOwnershipRenounced.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
})(coin_manager || (exports.coin_manager = coin_manager = {}));
var config;
(function (config) {
    let Config;
    (function (Config) {
...
(function (ecdsa_k1) {
    ...
    (function (builder) {
        ...
        function secp256k1Verify(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU8)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (ecvrf) {
    ...
    (function (builder) {
        function ecvrfVerify(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (group_ops) {
    ...
    (function (builder) {
        ...
        function setAsPrefix(tx, args) {
            const _args = [];
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrPureBool)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (iota) {
    ...
    (function (IOTA) {
        ...
        const TYPE = new move_1.TypeDescriptor(IOTA.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        IOTA.type = type;
    ...
    (function (IotaTreasuryCap) {
        ...
        const TYPE = new move_1.TypeDescriptor(IotaTreasuryCap.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (kiosk_extension) {
    ...
    (function (builder) {
        function add(tx, args, typeArguments) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU128)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (labeler) {
    ...
    (function (LabelerCap) {
        ...
        const TYPE = new move_1.TypeDescriptor(LabelerCap.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
...
})(labeler || (exports.labeler = labeler = {}));
var linked_table;
...
(function (random) {
    ...
    (function (builder) {
        ...
        function generateU128InRange(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrPureU128)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function generateU16InRange(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU16)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU16)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function generateU32InRange(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrPureU32)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (system_admin_cap) {
    ...
    (function (IotaSystemAdminCap) {
        ...
        const TYPE = new move_1.TypeDescriptor(IotaSystemAdminCap.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        IotaSystemAdminCap.type = type;
    })(IotaSystemAdminCap = system_admin_cap.IotaSystemAdminCap || (system_admin_cap.IotaSystemAdminCap = {}));
})(system_admin_cap || (exports.system_admin_cap = system_admin_cap = {}));
var table;
(function (table) {
    let Table;
    (function (Table) {
...
(function (timelock) {
    ...
    (function (TimeLock) {
        ...
        const TYPE = new move_1.TypeDescriptor(TimeLock.TYPE_QNAME);
        function type(arg0 = move_1.ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        TimeLock.type = type;
...
})(timelock || (exports.timelock = timelock = {}));
var token;
(function (token) {
    let ActionRequest;
...
(function (zklogin_verified_id) {
    ...
    (function (builder) {
        ...
        function checkZkloginId(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[3], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[4], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU256)(args[5], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function verifyZkloginId(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrPure)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[3], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU256)(args[4], tx));
            // @ts-ignore
            return tx.moveCall({
