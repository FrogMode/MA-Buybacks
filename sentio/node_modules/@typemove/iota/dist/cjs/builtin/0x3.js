...
exports.voting_power = exports.validator_wrapper = exports.validator_set = exports.validator_cap = exports.validator = exports.timelocked_staking = exports.storage_fund = exports.staking_pool = exports.iota_system_state_inner = exports.iota_system = exports.genesis = void 0;
...
(function (genesis) {
    ...
    (function (GenesisChainParameters) {
        ...
        const TYPE = new move_1.TypeDescriptor(GenesisChainParameters.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (GenesisValidatorMetadata) {
        ...
        const TYPE = new move_1.TypeDescriptor(GenesisValidatorMetadata.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (TokenAllocation) {
        ...
        const TYPE = new move_1.TypeDescriptor(TokenAllocation.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (TokenDistributionSchedule) {
        ...
        const TYPE = new move_1.TypeDescriptor(TokenDistributionSchedule.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (iota_system) {
    ...
    (function (builder) {
        ...
        function create(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrVec)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[3], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[4], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[5], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[6], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[7], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function reportValidator(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrPureAddress)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function requestAddStakeMulCoin(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrPureAddress)(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function requestAddValidatorCandidate(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrVec)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[3], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[4], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[5], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[6], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[7], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[8], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[9], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[10], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[11], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[12], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[13], tx));
            // @ts-ignore
            return tx.moveCall({
...
})(iota_system || (exports.iota_system = iota_system = {}));
var iota_system_state_inner;
(function (iota_system_state_inner) {
    ...
    (function (IotaSystemStateV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(IotaSystemStateV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (IotaSystemStateV2) {
        ...
        const TYPE = new move_1.TypeDescriptor(IotaSystemStateV2.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (SystemEpochInfoEventV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(SystemEpochInfoEventV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (SystemEpochInfoEventV2) {
        ...
        const TYPE = new move_1.TypeDescriptor(SystemEpochInfoEventV2.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (SystemParametersV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(SystemParametersV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (builder) {
        ...
        function advanceEpoch(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[3], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[4], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[5], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[6], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[7], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[8], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[9], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[10], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[11], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function getReportersOf(tx, args) {
            const _args = [];
            _args.push((0, iota_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrPureAddress)(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
...
})(iota_system_state_inner || (exports.iota_system_state_inner = iota_system_state_inner = {}));
var staking_pool;
(function (staking_pool) {
    ...
    (function (PoolTokenExchangeRate) {
        ...
        const TYPE = new move_1.TypeDescriptor(PoolTokenExchangeRate.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (StakedIota) {
        ...
        const TYPE = new move_1.TypeDescriptor(StakedIota.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (StakingPoolV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(StakingPoolV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (storage_fund) {
    ...
    (function (StorageFundV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(StorageFundV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
})(storage_fund || (exports.storage_fund = storage_fund = {}));
var timelocked_staking;
(function (timelocked_staking) {
    ...
    (function (TimelockedStakedIota) {
        ...
        const TYPE = new move_1.TypeDescriptor(TimelockedStakedIota.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
})(timelocked_staking || (exports.timelocked_staking = timelocked_staking = {}));
var validator;
(function (validator) {
    ...
    (function (ValidatorMetadataV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorMetadataV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (builder) {
        ...
        function new$(tx, args) {
            const _args = [];
            _args.push((0, iota_3.transactionArgumentOrPureAddress)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[3], tx));
            _args.push((0, iota_3.transactionArgumentOrVec)(args[4], tx));
        ...
        function newMetadata(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrPure)(args[6], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[7], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[8], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[9], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[10], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[11], tx));
            _args.push((0, iota_3.transactionArgumentOrPure)(args[12], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (validator_cap) {
    ...
    (function (UnverifiedValidatorOperationCap) {
        ...
        const TYPE = new move_1.TypeDescriptor(UnverifiedValidatorOperationCap.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorOperationCap) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorOperationCap.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (validator_set) {
    ...
    (function (CommitteeValidatorJoinEvent) {
        ...
        const TYPE = new move_1.TypeDescriptor(CommitteeValidatorJoinEvent.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (CommitteeValidatorLeaveEvent) {
        ...
        const TYPE = new move_1.TypeDescriptor(CommitteeValidatorLeaveEvent.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorEpochInfoEventV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorEpochInfoEventV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorJoinEvent) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorJoinEvent.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorLeaveEvent) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorLeaveEvent.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorSetV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorSetV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (ValidatorSetV2) {
        ...
        const TYPE = new move_1.TypeDescriptor(ValidatorSetV2.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
    ...
    (function (builder) {
        ...
        function advanceEpoch(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[2], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[3], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[4], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[5], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU64)(args[6], tx));
        ...
        function getActiveOrPendingOrCandidateValidatorRef(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrPureAddress)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrPureU8)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        function getValidatorMutWithVerifiedCap(tx, args) {
            ...
            _args.push((0, iota_3.transactionArgumentOrObject)(args[0], tx));
            _args.push((0, iota_3.transactionArgumentOrObject)(args[1], tx));
            _args.push((0, iota_3.transactionArgumentOrPureBool)(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
...
(function (voting_power) {
    ...
    (function (VotingPowerInfoV1) {
        ...
        const TYPE = new move_1.TypeDescriptor(VotingPowerInfoV1.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
