...
async function codegen(abisDir, outDir = (0, path_1.join)('src', 'types', 'sui'), endpoint, genExample = false, builtin = false) {
    ...
    try {
        ...
        if (numFiles > 0) {
            console.log(chalk_1.default.green(`Generated for ${numFiles} accounts for Iota to ${outDir}`));
        }
        else {
...
class IotaCodegen extends codegen_1.AbstractCodegen {
    ADDRESS_TYPE = 'string';
    ...
    constructor(endpoint) {
        super(new sui_chain_adapter_js_1.IotaChainAdapter(new client_1.IotaClient({ url: endpoint })));
    }
...
exports.IotaCodegen = IotaCodegen;
