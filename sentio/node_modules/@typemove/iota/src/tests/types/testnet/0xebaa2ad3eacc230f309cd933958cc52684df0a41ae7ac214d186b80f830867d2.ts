...
export namespace single_collateral {
  ...
  export namespace builder {
    ...
    export function authorizedNewPortfolioVault<T0 = any, T1 = any, T2 = any>(
      ...
      _args.push(transactionArgumentOrPureU64(args[16], tx));
      _args.push(transactionArgumentOrPureU64(args[17], tx));
      _args.push(transactionArgumentOrPureU64(args[18], tx));
      _args.push(transactionArgumentOrPureU64(args[19], tx));
    ...
    export function newPortfolioVault<T0 = any, T1 = any, T2 = any>(
      ...
      _args.push(transactionArgumentOrPureU64(args[18], tx));
      _args.push(transactionArgumentOrPureU64(args[19], tx));
      _args.push(transactionArgumentOrPureU64(args[20], tx));
...
export namespace vault {
  ...
  export namespace builder {
    ...
    export function newBidVault<T0 = any, T1 = any>(
      tx: Transaction,
      args: [bigint | TransactionArgument, string | TransactionObjectArgument],
      typeArguments: [TypeDescriptor<T0> | string, TypeDescriptor<T1> | string],
    ): TransactionArgument & [TransactionArgument, TransactionArgument] {
      const _args: any[] = [];
      _args.push(transactionArgumentOrPureU64(args[0], tx));
