...
import { EntryFunctionPayloadResponse, MoveResource, Event, WriteSetChangeWriteResource, WriteSetChangeDeleteResource } from '@aptos-labs/ts-sdk';
...
export type ResourceChange<T> = NestedDecodedStruct<MoveResource, WriteSetChangeWriteResource, T> | WriteSetChangeDeleteResource;
