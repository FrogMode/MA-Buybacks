...
class AccountResourceClient {
    ...
    async matchExact(accountAddress, resourceType, options) {
        ...
        return (0, move_coder_js_1.defaultMoveCoder)(this.client.config).decodeResource(resource);
    }
    /**
    ...
    async matchAll(accountAddress, resourceType, options) {
        ...
        return (0, move_coder_js_1.defaultMoveCoder)(this.client.config).filterAndDecodeResources(resourceType, result);
    }
}
