...
export class AccountResourceClient {
    ...
    async matchExact(accountAddress, resourceType, options) {
        ...
        return defaultMoveCoder(this.client.config).decodeResource(resource);
    }
    /**
    ...
    async matchAll(accountAddress, resourceType, options) {
        ...
        return defaultMoveCoder(this.client.config).filterAndDecodeResources(resourceType, result);
    }
}
