...
import { camel, normalizeToJSName, structQname } from '@typemove/move';
import { AbstractCodegen } from '@typemove/move/codegen';
import { Aptos } from '@aptos-labs/ts-sdk';
export async function codegen(abisDir, outDir = join('src', 'types', 'aptos'), config, genExample = false, builtin = false) {
...
export class AptosCodegen extends AbstractCodegen {
    useViewJson;
