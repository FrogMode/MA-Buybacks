 ...
 */
declare function niop_args(ra: number, rb: number, rc: number, args: NarrowMathArgs): Instruction;
/**
 ...
 */
declare function niop(dst: number, lhs: number, rhs: number, flags: number): Instruction;
/**
 * Return from context.
 */
 ...
 */
declare function ldc(src_addr: number, offset: number, len: number, mode: number): Instruction;
/**
 * Log an event.
 */
 ...
 */
declare function ed19(pub_key_addr: number, sig_addr: number, msg_addr: number, msg_len: number): Instruction;
/**
 ...
 */
declare function lqw(dst: number, arg: number, offset: number): Instruction;
/**
 * Load halfword (u32).
 */
declare function lhw(dst: number, arg: number, offset: number): Instruction;
/**
 * Store quarterword (u16).
 */
declare function sqw(dst: number, arg: number, offset: number): Instruction;
/**
 * Store halfword (u32).
 */
declare function shw(dst: number, arg: number, offset: number): Instruction;
/**
 ...
 */
declare function jal(ret_addr: number, target: number, offset: number): Instruction;
/**
 ...
 * Get blob size
 */
declare function bsiz(dst: number, blob_id_ptr: number): Instruction;
/**
 * Load blob as data
 */
declare function bldd(dst_ptr: number, blob_id_ptr: number, offset: number, len: number): Instruction;
/**
 * Given some curve, performs an operation on points
 */
declare function ecop(dst: number, curve_id: number, operation_type: number, points_ptr: number): Instruction;
/**
 * Given some curve, performs a pairing on groups of points
 */
declare function epar(success: number, curve_id: number, number_elements: number, points_ptr: number): Instruction;
/**
...
declare class BLDD {
   ...
   * Construct the instruction from its parts.
   */
  constructor(dst_ptr: RegId, blob_id_ptr: RegId, offset: RegId, len: RegId);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class BSIZ {
   ...
   * Construct the instruction from its parts.
   */
  constructor(dst: RegId, blob_id_ptr: RegId);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class ECOP {
   ...
   * Construct the instruction from its parts.
   */
  constructor(dst: RegId, curve_id: RegId, operation_type: RegId, points_ptr: RegId);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class ED19 {
   ...
   * Construct the instruction from its parts.
   */
  constructor(pub_key_addr: RegId, sig_addr: RegId, msg_addr: RegId, msg_len: RegId);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class EPAR {
   ...
   * Construct the instruction from its parts.
   */
  constructor(success: RegId, curve_id: RegId, number_elements: RegId, points_ptr: RegId);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class JAL {
   ...
   * Construct the instruction from its parts.
   */
  constructor(ret_addr: RegId, target: RegId, offset: Imm12);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class LDC {
   ...
   * Construct the instruction from its parts.
   */
  constructor(src_addr: RegId, offset: RegId, len: RegId, mode: Imm06);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class LHW {
   ...
   * Construct the instruction from its parts.
   */
  constructor(dst: RegId, arg: RegId, offset: Imm12);
  /**
   * Access the ID for register A.
   */
  ra(): RegId;
...
declare class MathArgs {
   ...
   */
  constructor(op: NarrowMathOp, width: OpWidth);
  /**
...
declare class NIOP {
   ...
   */
  static from_args(ra: RegId, rb: RegId, rc: RegId, args: NarrowMathArgs): NIOP;
  /**
   * Construct the instruction from its parts.
   */
...
interface InitOutput {
  ...
  readonly __wbg_narrowmathargs_free: (a: number, b: number) => void;
  readonly __wbg_get_narrowmathargs_op: (a: number) => number;
  readonly __wbg_set_narrowmathargs_op: (a: number, b: number) => void;
  readonly __wbg_get_narrowmathargs_width: (a: number) => number;
  readonly __wbg_set_narrowmathargs_width: (a: number, b: number) => void;
  readonly mathargs_new: (a: number, b: number) => number;
  readonly __wbg_compareargs_free: (a: number, b: number) => void;
  ...
  readonly niop_from_args: (a: number, b: number, c: number, d: number) => number;
  readonly niop_args: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly __wbg_imm06_free: (a: number, b: number) => void;
  readonly __wbg_imm12_free: (a: number, b: number) => void;
  readonly __wbg_imm18_free: (a: number, b: number) => void;
  readonly __wbg_add_free: (a: number, b: number) => void;
  readonly __wbg_noop_free: (a: number, b: number) => void;
  ...
  readonly niop_new_typescript: (a: number, b: number, c: number, d: number) => number;
  readonly niop: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly ldc: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly ed19: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly lqw: (a: number, b: number, c: number) => number;
  readonly lhw: (a: number, b: number, c: number) => number;
  readonly sqw: (a: number, b: number, c: number) => number;
  readonly shw: (a: number, b: number, c: number) => number;
  ...
  readonly jal: (a: number, b: number, c: number) => number;
  ...
  readonly bsiz: (a: number, b: number) => number;
  readonly bldd_new_typescript: (a: number, b: number, c: number, d: number) => number;
  readonly bldd_rd: (a: number) => number;
  readonly bldd: (a: number, b: number, c: number, d: number) => number;
  readonly ecop: (a: number, b: number, c: number, d: number) => number;
  readonly epar: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly lqw_new_typescript: (a: number, b: number, c: number) => number;
  readonly lhw_new_typescript: (a: number, b: number, c: number) => number;
  readonly sqw_new_typescript: (a: number, b: number, c: number) => number;
  readonly shw_new_typescript: (a: number, b: number, c: number) => number;
  ...
  readonly jal_new_typescript: (a: number, b: number, c: number) => number;
  ...
  readonly bsiz_new_typescript: (a: number, b: number) => number;
  ...
  readonly ed19_new_typescript: (a: number, b: number, c: number, d: number) => number;
  readonly smo_new_typescript: (a: number, b: number, c: number, d: number) => number;
  readonly ldc_new_typescript: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly ecop_new_typescript: (a: number, b: number, c: number, d: number) => number;
  readonly epar_new_typescript: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly __wbg_regid_free: (a: number, b: number) => void;
  readonly __wbg_imm24_free: (a: number, b: number) => void;
  readonly __wbg_mathargs_free: (a: number, b: number) => void;
  readonly __wbg_movi_free: (a: number, b: number) => void;
  readonly __wbg_tro_free: (a: number, b: number) => void;
  readonly __wbg_logd_free: (a: number, b: number) => void;
  readonly __wbg_jmp_free: (a: number, b: number) => void;
  readonly __wbg_andi_free: (a: number, b: number) => void;
  readonly __wbg_bal_free: (a: number, b: number) => void;
  readonly __wbg_lqw_free: (a: number, b: number) => void;
  readonly __wbg_jal_free: (a: number, b: number) => void;
  readonly jmp_ra: (a: number) => number;
  readonly __wbg_bhei_free: (a: number, b: number) => void;
  readonly __wbg_srli_free: (a: number, b: number) => void;
  readonly cb_ra: (a: number) => number;
  readonly __wbg_cb_free: (a: number, b: number) => void;
  readonly __wbg_srl_free: (a: number, b: number) => void;
  readonly __wbg_mlog_free: (a: number, b: number) => void;
  readonly __wbg_lhw_free: (a: number, b: number) => void;
  readonly __wbg_jne_free: (a: number, b: number) => void;
  readonly __wbg_modi_free: (a: number, b: number) => void;
  readonly rvrt_ra: (a: number) => number;
  readonly __wbg_rvrt_free: (a: number, b: number) => void;
  readonly __wbg_k256_free: (a: number, b: number) => void;
  readonly __wbg_eq_free: (a: number, b: number) => void;
  readonly __wbg_lb_free: (a: number, b: number) => void;
  readonly __wbg_move_free: (a: number, b: number) => void;
  readonly __wbg_lt_free: (a: number, b: number) => void;
  readonly bhei_ra: (a: number) => number;
  readonly __wbg_aloc_free: (a: number, b: number) => void;
  readonly ret_ra: (a: number) => number;
  readonly __wbg_ret_free: (a: number, b: number) => void;
  readonly __wbg_gtf_free: (a: number, b: number) => void;
  readonly __wbg_bsiz_free: (a: number, b: number) => void;
  readonly __wbg_ecal_free: (a: number, b: number) => void;
  readonly __wbg_meq_free: (a: number, b: number) => void;
  readonly __wbg_wqmd_free: (a: number, b: number) => void;
  readonly __wbg_sll_free: (a: number, b: number) => void;
  readonly __wbg_bldd_free: (a: number, b: number) => void;
  readonly __wbg_mcp_free: (a: number, b: number) => void;
  readonly __wbg_jnef_free: (a: number, b: number) => void;
  readonly __wbg_ccp_free: (a: number, b: number) => void;
  readonly __wbg_popl_free: (a: number, b: number) => void;
  readonly __wbg_wqam_free: (a: number, b: number) => void;
  readonly __wbg_gm_free: (a: number, b: number) => void;
  readonly __wbg_wdam_free: (a: number, b: number) => void;
  readonly __wbg_call_free: (a: number, b: number) => void;
  readonly __wbg_smo_free: (a: number, b: number) => void;
  readonly popl_imm24: (a: number) => number;
  readonly __wbg_ji_free: (a: number, b: number) => void;
  readonly __wbg_and_free: (a: number, b: number) => void;
  readonly __wbg_exp_free: (a: number, b: number) => void;
  readonly __wbg_lw_free: (a: number, b: number) => void;
  readonly __wbg_sb_free: (a: number, b: number) => void;
  readonly __wbg_s256_free: (a: number, b: number) => void;
  readonly __wbg_ori_free: (a: number, b: number) => void;
  readonly __wbg_gt_free: (a: number, b: number) => void;
  readonly __wbg_mroo_free: (a: number, b: number) => void;
  readonly __wbg_wqdv_free: (a: number, b: number) => void;
  readonly __wbg_wddv_free: (a: number, b: number) => void;
  readonly __wbg_jnzb_free: (a: number, b: number) => void;
  readonly __wbg_xor_free: (a: number, b: number) => void;
  readonly __wbg_ed19_free: (a: number, b: number) => void;
  readonly ji_imm24: (a: number) => number;
  readonly __wbg_cfsi_free: (a: number, b: number) => void;
  readonly __wbg_jmpb_free: (a: number, b: number) => void;
  readonly __wbg_sqw_free: (a: number, b: number) => void;
  readonly __wbg_shw_free: (a: number, b: number) => void;
  readonly __wbg_mcl_free: (a: number, b: number) => void;
  readonly __wbg_ecop_free: (a: number, b: number) => void;
  readonly __wbg_jnei_free: (a: number, b: number) => void;
  readonly __wbg_swwq_free: (a: number, b: number) => void;
  readonly __wbg_srw_free: (a: number, b: number) => void;
  readonly __wbg_mod_free: (a: number, b: number) => void;
  readonly __wbg_wdmm_free: (a: number, b: number) => void;
  readonly __wbg_tr_free: (a: number, b: number) => void;
  readonly __wbg_sw_free: (a: number, b: number) => void;
  readonly __wbg_ldc_free: (a: number, b: number) => void;
  readonly __wbg_sww_free: (a: number, b: number) => void;
  readonly cfsi_imm24: (a: number) => number;
  readonly __wbg_cfei_free: (a: number, b: number) => void;
  readonly __wbg_srwq_free: (a: number, b: number) => void;
  readonly __wbg_croo_free: (a: number, b: number) => void;
  readonly __wbg_or_free: (a: number, b: number) => void;
  readonly __wbg_log_free: (a: number, b: number) => void;
  readonly __wbg_mldv_free: (a: number, b: number) => void;
  readonly __wbg_burn_free: (a: number, b: number) => void;
  readonly __wbg_muli_free: (a: number, b: number) => void;
  readonly __wbg_wqmm_free: (a: number, b: number) => void;
  readonly flag_ra: (a: number) => number;
  readonly __wbg_flag_free: (a: number, b: number) => void;
  readonly __wbg_jnzi_free: (a: number, b: number) => void;
  readonly poph_imm24: (a: number) => number;
  readonly __wbg_poph_free: (a: number, b: number) => void;
  readonly cfs_ra: (a: number) => number;
  readonly __wbg_cfs_free: (a: number, b: number) => void;
  readonly __wbg_div_free: (a: number, b: number) => void;
  readonly pshl_imm24: (a: number) => number;
  readonly __wbg_pshl_free: (a: number, b: number) => void;
  readonly __wbg_sub_free: (a: number, b: number) => void;
  readonly __wbg_subi_free: (a: number, b: number) => void;
  readonly __wbg_epar_free: (a: number, b: number) => void;
  readonly __wbg_csiz_free: (a: number, b: number) => void;
  readonly __wbg_niop_free: (a: number, b: number) => void;
  readonly pshh_imm24: (a: number) => number;
  readonly __wbg_pshh_free: (a: number, b: number) => void;
  readonly __wbg_not_free: (a: number, b: number) => void;
  readonly __wbg_jneb_free: (a: number, b: number) => void;
  readonly cfe_ra: (a: number) => number;
  readonly __wbg_cfe_free: (a: number, b: number) => void;
  readonly __wbg_mcli_free: (a: number, b: number) => void;
  readonly __wbg_wqml_free: (a: number, b: number) => void;
  readonly __wbg_addi_free: (a: number, b: number) => void;
  readonly __wbg_bhsh_free: (a: number, b: number) => void;
  readonly __wbg_expi_free: (a: number, b: number) => void;
  readonly __wbg_scwq_free: (a: number, b: number) => void;
  readonly __wbg_mint_free: (a: number, b: number) => void;
  readonly __wbg_time_free: (a: number, b: number) => void;
  readonly __wbg_xori_free: (a: number, b: number) => void;
  readonly __wbg_wdop_free: (a: number, b: number) => void;
  readonly __wbg_retd_free: (a: number, b: number) => void;
  readonly __wbg_wqop_free: (a: number, b: number) => void;
  readonly __wbg_eck1_free: (a: number, b: number) => void;
  readonly __wbg_slli_free: (a: number, b: number) => void;
  readonly __wbg_wdmd_free: (a: number, b: number) => void;
  readonly __wbg_mcpi_free: (a: number, b: number) => void;
  readonly __wbg_jmpf_free: (a: number, b: number) => void;
  readonly __wbg_wdcm_free: (a: number, b: number) => void;
  readonly __wbg_wdml_free: (a: number, b: number) => void;
  readonly __wbg_jnzf_free: (a: number, b: number) => void;
  readonly __wbg_ecr1_free: (a: number, b: number) => void;
  readonly __wbg_mul_free: (a: number, b: number) => void;
  readonly __wbg_wqcm_free: (a: number, b: number) => void;
  readonly __wbg_divi_free: (a: number, b: number) => void;
  ...
  readonly lqw_imm12: (a: number) => number;
  readonly lqw_rb: (a: number) => number;
  readonly lqw_ra: (a: number) => number;
  readonly jal_imm12: (a: number) => number;
  readonly jal_rb: (a: number) => number;
  readonly jal_ra: (a: number) => number;
  ...
  readonly lhw_imm12: (a: number) => number;
  readonly lhw_rb: (a: number) => number;
  readonly lhw_ra: (a: number) => number;
  ...
  readonly bsiz_rb: (a: number) => number;
  readonly bsiz_ra: (a: number) => number;
  ...
  readonly bldd_rc: (a: number) => number;
  readonly bldd_rb: (a: number) => number;
  readonly bldd_ra: (a: number) => number;
  ...
  readonly ed19_rd: (a: number) => number;
  ...
  readonly sqw_imm12: (a: number) => number;
  readonly sqw_rb: (a: number) => number;
  readonly sqw_ra: (a: number) => number;
  readonly shw_imm12: (a: number) => number;
  readonly shw_rb: (a: number) => number;
  readonly shw_ra: (a: number) => number;
  readonly mcl_rb: (a: number) => number;
  readonly mcl_ra: (a: number) => number;
  readonly ecop_rd: (a: number) => number;
  readonly ecop_rc: (a: number) => number;
  readonly ecop_rb: (a: number) => number;
  readonly ecop_ra: (a: number) => number;
  ...
  readonly ldc_imm06: (a: number) => number;
  ...
  readonly epar_rd: (a: number) => number;
  readonly epar_rc: (a: number) => number;
  readonly epar_rb: (a: number) => number;
  readonly epar_ra: (a: number) => number;
  readonly csiz_rb: (a: number) => number;
  readonly csiz_ra: (a: number) => number;
  readonly niop_imm06: (a: number) => number;
  readonly niop_rc: (a: number) => number;
  readonly niop_rb: (a: number) => number;
  readonly niop_ra: (a: number) => number;
...
export { ADD, ADDI, ALOC, AND, ANDI, BAL, BHEI, BHSH, BLDD, BSIZ, BURN, CALL, CB, CCP, CFE, CFEI, CFS, CFSI, CROO, CSIZ, CompareArgs, CompareMode, DIV, DIVI, DivArgs, ECAL, ECK1, ECOP, ECR1, ED19, EPAR, EQ, EXP, EXPI, FLAG, GM, GMArgs, GT, GTF, GTFArgs, Imm06, Imm12, Imm18, Imm24, InitInput, InitOutput, Instruction, JAL, JI, JMP, JMPB, JMPF, JNE, JNEB, JNEF, JNEI, JNZB, JNZF, JNZI, K256, LB, LDC, LHW, LOG, LOGD, LQW, LT, LW, MCL, MCLI, MCP, MCPI, MEQ, MINT, MLDV, MLOG, MOD, MODI, MOVE, MOVI, MROO, MUL, MULI, MathArgs, MathOp, MulArgs, NIOP, NOOP, NOT, NarrowMathArgs, NarrowMathOp, OR, ORI, OpWidth, POPH, POPL, PSHH, PSHL, PanicInstruction, PanicReason, RET, RETD, RVRT, RegId, S256, SB, SCWQ, SHW, SLL, SLLI, SMO, SQW, SRL, SRLI, SRW, SRWQ, SUB, SUBI, SW, SWW, SWWQ, SyncInitInput, TIME, TR, TRO, WDAM, WDCM, WDDV, WDMD, WDML, WDMM, WDOP, WQAM, WQCM, WQDV, WQMD, WQML, WQMM, WQOP, XOR, XORI, add, addi, aloc, and, andi, bal, bhei, bhsh, bldd, bsiz, burn, call, cb, ccp, cfe, cfei, cfs, cfsi, croo, csiz, __wbg_init as default, div, divi, ecal, eck1, ecop, ecr1, ed19, epar, eq, exp, expi, flag, gm, gm_args, gt, gtf, gtf_args, initSync, jal, ji, jmp, jmpb, jmpf, jne, jneb, jnef, jnei, jnzb, jnzf, jnzi, k256, lb, ldc, lhw, log, logd, lqw, lt, lw, mcl, mcli, mcp, mcpi, meq, mint, mldv, mlog, mod_, modi, move_, movi, mroo, mul, muli, niop, niop_args, noop, not, or, ori, poph, popl, pshh, pshl, ret, retd, rvrt, s256, sb, scwq, shw, sll, slli, smo, sqw, srl, srli, srw, srwq, sub, subi, sw, sww, swwq, time, tr, tro, wdam, wdcm, wdcm_args, wddv, wddv_args, wdmd, wdml, wdml_args, wdmm, wdop, wdop_args, wqam, wqcm, wqcm_args, wqdv, wqdv_args, wqmd, wqml, wqml_args, wqmm, wqop, wqop_args, xor, xori };
