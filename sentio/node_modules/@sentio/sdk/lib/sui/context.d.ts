...
import { SuiTransactionBlockResponse, SuiEvent, SuiMoveNormalizedModule, SuiMoveObject, SuiClient } from '@mysten/sui/client';
...
export declare class SuiObjectContext extends SuiAddressContext {
    ...
    constructor(network: SuiNetwork, objectId: string, objectVersion: bigint, checkpoint: bigint, timestamp: Date, baseLabels: Labels | undefined);
}
