...
export declare class party extends SuiBaseProcessor {
    constructor(options: SuiBindOptions);
    static DEFAULT_OPTIONS: SuiBindOptions;
    static bind(options?: Partial<SuiBindOptions>): party;
    onEventParty(func: (event: party.PartyInstance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, party.PartyInstance>, eventFilter?: Omit<EventFilter, "type" | "account">): party;
    onEventPermissions(func: (event: party.PermissionsInstance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, party.PermissionsInstance>, eventFilter?: Omit<EventFilter, "type" | "account">): party;
}
