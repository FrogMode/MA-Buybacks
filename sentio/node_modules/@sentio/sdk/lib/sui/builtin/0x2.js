...
import { transactionArgumentOrObject, transactionArgumentOrVec, transactionArgumentOrPure, transactionArgumentOrPureU8, transactionArgumentOrPureU16, transactionArgumentOrPureU32, transactionArgumentOrPureU64, transactionArgumentOrPureU128, transactionArgumentOrPureU256, transactionArgumentOrPureBool, transactionArgumentOrPureAddress, } from "@typemove/sui";
import { SuiBaseProcessor, SuiNetwork, } from "@sentio/sdk/sui";
import * as _0x1 from "./0x1.js";
export class accumulator extends SuiBaseProcessor {
    constructor(options) {
        super("accumulator", options);
    }
    ...
    static bind(options = {}) {
        return new accumulator({ ...accumulator.DEFAULT_OPTIONS, ...options });
    }
    onEventKey(func, handlerOptions, eventFilter) {
        this.onMoveEvent(func, { ...(eventFilter ?? {}), type: "accumulator::Key" }, handlerOptions);
        return this;
    }
}
(function (accumulator) {
    let AccumulatorRoot;
    (function (AccumulatorRoot) {
        AccumulatorRoot.TYPE_QNAME = "0x2::accumulator::AccumulatorRoot";
        const TYPE = new TypeDescriptor(AccumulatorRoot.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        AccumulatorRoot.type = type;
    })(AccumulatorRoot = accumulator.AccumulatorRoot || (accumulator.AccumulatorRoot = {}));
    let Key;
    (function (Key) {
        Key.TYPE_QNAME = "0x2::accumulator::Key";
        const TYPE = new TypeDescriptor(Key.TYPE_QNAME);
        function type(arg0 = ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        Key.type = type;
    })(Key = accumulator.Key || (accumulator.Key = {}));
    let U128;
    (function (U128) {
        U128.TYPE_QNAME = "0x2::accumulator::U128";
        const TYPE = new TypeDescriptor(U128.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        U128.type = type;
    })(U128 = accumulator.U128 || (accumulator.U128 = {}));
    let builder;
    (function (builder) {
        function accumulatorAddress(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPureAddress(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::accumulator_address",
                arguments: _args,
                typeArguments: [
        ...
        builder.accumulatorAddress = accumulatorAddress;
        function accumulatorKey(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPureAddress(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::accumulator_key",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        function createU128(tx, args) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::create_u128",
                arguments: _args,
            });
        }
        builder.createU128 = createU128;
        function destroyU128(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrPure(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::destroy_u128",
                arguments: _args,
            });
        }
        builder.destroyU128 = destroyU128;
        function emitDepositEvent(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPureAddress(args[0], tx));
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::emit_deposit_event",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.emitDepositEvent = emitDepositEvent;
        function emitWithdrawEvent(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPureAddress(args[0], tx));
            _args.push(transactionArgumentOrPureAddress(args[1], tx));
            _args.push(transactionArgumentOrPureU64(args[2], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::emit_withdraw_event",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.emitWithdrawEvent = emitWithdrawEvent;
        function isZeroU128(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::is_zero_u128",
                arguments: _args,
            });
        }
        builder.isZeroU128 = isZeroU128;
        function rootAddAccumulator(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::root_add_accumulator",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        function rootBorrowAccumulatorMut(tx, args, typeArguments) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::root_borrow_accumulator_mut",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.rootBorrowAccumulatorMut = rootBorrowAccumulatorMut;
        function rootHasAccumulator(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            _args.push(transactionArgumentOrPure(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::root_has_accumulator",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.rootHasAccumulator = rootHasAccumulator;
        function rootId(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::root_id",
                arguments: _args,
            });
        }
        builder.rootId = rootId;
        function rootIdMut(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::root_id_mut",
                arguments: _args,
            });
        }
        builder.rootIdMut = rootIdMut;
        function rootRemoveAccumulator(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            _args.push(transactionArgumentOrPure(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::root_remove_accumulator",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.rootRemoveAccumulator = rootRemoveAccumulator;
        function updateU128(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::accumulator::update_u128",
                arguments: _args,
            });
        }
        builder.updateU128 = updateU128;
    })(builder = accumulator.builder || (accumulator.builder = {}));
    let view;
    (function (view) {
        async function accumulatorAddress(client, args, typeArguments) {
            const tx = new Transaction();
            builder.accumulatorAddress(tx, args, typeArguments);
        ...
        view.accumulatorAddress = accumulatorAddress;
        async function accumulatorKey(client, args, typeArguments) {
            const tx = new Transaction();
            builder.accumulatorKey(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.createU128 = createU128;
        async function destroyU128(client, args) {
            const tx = new Transaction();
            builder.destroyU128(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.destroyU128 = destroyU128;
        async function emitDepositEvent(client, args, typeArguments) {
            const tx = new Transaction();
        ...
        view.emitDepositEvent = emitDepositEvent;
        async function emitWithdrawEvent(client, args, typeArguments) {
            const tx = new Transaction();
        ...
        view.emitWithdrawEvent = emitWithdrawEvent;
        async function isZeroU128(client, args) {
            const tx = new Transaction();
            builder.isZeroU128(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.isZeroU128 = isZeroU128;
        async function rootAddAccumulator(client, args, typeArguments) {
            const tx = new Transaction();
            builder.rootAddAccumulator(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.rootBorrowAccumulatorMut = rootBorrowAccumulatorMut;
        async function rootHasAccumulator(client, args, typeArguments) {
            const tx = new Transaction();
            builder.rootHasAccumulator(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.rootHasAccumulator = rootHasAccumulator;
        async function rootId(client, args) {
            const tx = new Transaction();
            builder.rootId(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.rootId = rootId;
        async function rootIdMut(client, args) {
            const tx = new Transaction();
            builder.rootIdMut(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.rootIdMut = rootIdMut;
        async function rootRemoveAccumulator(client, args, typeArguments) {
            const tx = new Transaction();
            builder.rootRemoveAccumulator(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.rootRemoveAccumulator = rootRemoveAccumulator;
        async function updateU128(client, args) {
            const tx = new Transaction();
            builder.updateU128(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.updateU128 = updateU128;
    })(view = accumulator.view || (accumulator.view = {}));
})(accumulator || (accumulator = {}));
export class accumulator_metadata extends SuiBaseProcessor {
    constructor(options) {
        super("accumulator_metadata", options);
    }
    static DEFAULT_OPTIONS = {
        address: "0x2",
        network: SuiNetwork.MAIN_NET,
    ...
    static bind(options = {}) {
        return new accumulator_metadata({
            ...accumulator_metadata.DEFAULT_OPTIONS,
            ...options,
        });
    }
    ...
    onEventOwnerKey(func, handlerOptions, eventFilter) {
        this.onMoveEvent(func, { ...(eventFilter ?? {}), type: "accumulator_metadata::OwnerKey" }, handlerOptions);
        return this;
    }
}
(function (accumulator_metadata) {
    ...
    (function (Metadata) {
        ...
        const TYPE = new TypeDescriptor(Metadata.TYPE_QNAME);
        function type(arg0 = ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        Metadata.type = type;
    })(Metadata = accumulator_metadata.Metadata || (accumulator_metadata.Metadata = {}));
    let MetadataKey;
    (function (MetadataKey) {
        MetadataKey.TYPE_QNAME = "0x2::accumulator_metadata::MetadataKey";
        const TYPE = new TypeDescriptor(MetadataKey.TYPE_QNAME);
        function type(arg0 = ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        MetadataKey.type = type;
    })(MetadataKey = accumulator_metadata.MetadataKey || (accumulator_metadata.MetadataKey = {}));
    let Owner;
    (function (Owner) {
        Owner.TYPE_QNAME = "0x2::accumulator_metadata::Owner";
        const TYPE = new TypeDescriptor(Owner.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        Owner.type = type;
    })(Owner = accumulator_metadata.Owner || (accumulator_metadata.Owner = {}));
    let OwnerKey;
    (function (OwnerKey) {
        OwnerKey.TYPE_QNAME = "0x2::accumulator_metadata::OwnerKey";
        const TYPE = new TypeDescriptor(OwnerKey.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        OwnerKey.type = type;
...
(function (coin) {
    ...
    (function (CurrencyCreated) {
        ...
        const TYPE = new TypeDescriptor(CurrencyCreated.TYPE_QNAME);
        function type(arg0 = ANY_TYPE) {
            return TYPE.apply(arg0);
        }
    ...
    (function (DenyCap) {
        ...
        const TYPE = new TypeDescriptor(DenyCap.TYPE_QNAME);
        function type(arg0 = ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        DenyCap.type = type;
    ...
    (function (DenyCapV2) {
        ...
        const TYPE = new TypeDescriptor(DenyCapV2.TYPE_QNAME);
        function type(arg0 = ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        DenyCapV2.type = type;
...
(function (deny_list) {
    ...
    (function (PerTypeList) {
        ...
        const TYPE = new TypeDescriptor(PerTypeList.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
export class derived_object extends SuiBaseProcessor {
    constructor(options) {
        super("derived_object", options);
    }
    static DEFAULT_OPTIONS = {
        address: "0x2",
        network: SuiNetwork.MAIN_NET,
    ...
    static bind(options = {}) {
        return new derived_object({
            ...derived_object.DEFAULT_OPTIONS,
            ...options,
        });
    }
    onEventClaimed(func, handlerOptions, eventFilter) {
        this.onMoveEvent(func, { ...(eventFilter ?? {}), type: "derived_object::Claimed" }, handlerOptions);
        return this;
    }
    onEventDerivedObjectKey(func, handlerOptions, eventFilter) {
        this.onMoveEvent(func, { ...(eventFilter ?? {}), type: "derived_object::DerivedObjectKey" }, handlerOptions);
        return this;
    }
}
(function (derived_object) {
    let ClaimedStatus;
    (function (ClaimedStatus) {
        ClaimedStatus.TYPE_QNAME = "0x2::derived_object::ClaimedStatus";
        const TYPE = new TypeDescriptor(ClaimedStatus.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        ClaimedStatus.type = type;
    })(ClaimedStatus = derived_object.ClaimedStatus || (derived_object.ClaimedStatus = {}));
    let Claimed;
    (function (Claimed) {
        Claimed.TYPE_QNAME = "0x2::derived_object::Claimed";
        const TYPE = new TypeDescriptor(Claimed.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        Claimed.type = type;
    })(Claimed = derived_object.Claimed || (derived_object.Claimed = {}));
    let DerivedObjectKey;
    (function (DerivedObjectKey) {
        DerivedObjectKey.TYPE_QNAME = "0x2::derived_object::DerivedObjectKey";
        const TYPE = new TypeDescriptor(DerivedObjectKey.TYPE_QNAME);
        function type(arg0 = ANY_TYPE) {
            return TYPE.apply(arg0);
        }
        DerivedObjectKey.type = type;
    })(DerivedObjectKey = derived_object.DerivedObjectKey || (derived_object.DerivedObjectKey = {}));
    let builder;
    (function (builder) {
        function claim(tx, args, typeArguments) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::derived_object::claim",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.claim = claim;
        function deriveAddress(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPure(args[0], tx));
            _args.push(transactionArgumentOrPure(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::derived_object::derive_address",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.deriveAddress = deriveAddress;
        function exists(tx, args, typeArguments) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::derived_object::exists",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
    ...
    })(builder = derived_object.builder || (derived_object.builder = {}));
    let view;
    (function (view) {
        ...
        view.claim = claim;
        async function deriveAddress(client, args, typeArguments) {
            const tx = new Transaction();
            builder.deriveAddress(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.deriveAddress = deriveAddress;
        ...
        view.exists = exists;
    })(view = derived_object.view || (derived_object.view = {}));
...
export class nitro_attestation extends SuiBaseProcessor {
    constructor(options) {
        super("nitro_attestation", options);
    }
    static DEFAULT_OPTIONS = {
        address: "0x2",
        network: SuiNetwork.MAIN_NET,
    ...
    static bind(options = {}) {
        return new nitro_attestation({
            ...nitro_attestation.DEFAULT_OPTIONS,
            ...options,
        });
    }
...
(function (nitro_attestation) {
    let NitroAttestationDocument;
    (function (NitroAttestationDocument) {
        NitroAttestationDocument.TYPE_QNAME = "0x2::nitro_attestation::NitroAttestationDocument";
        const TYPE = new TypeDescriptor(NitroAttestationDocument.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        NitroAttestationDocument.type = type;
    })(NitroAttestationDocument = nitro_attestation.NitroAttestationDocument || (nitro_attestation.NitroAttestationDocument = {}));
    let PCREntry;
    (function (PCREntry) {
        PCREntry.TYPE_QNAME = "0x2::nitro_attestation::PCREntry";
        const TYPE = new TypeDescriptor(PCREntry.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        PCREntry.type = type;
    })(PCREntry = nitro_attestation.PCREntry || (nitro_attestation.PCREntry = {}));
    let builder;
    (function (builder) {
        function digest(tx, args) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::digest",
                arguments: _args,
            });
        }
        ...
        function index(tx, args) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::index",
                arguments: _args,
            });
        }
        builder.index = index;
        function loadNitroAttestation(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrVec(args[0], tx));
            _args.push(transactionArgumentOrObject(args[1], tx));
            // @ts-ignore
        ...
        builder.loadNitroAttestation = loadNitroAttestation;
        function moduleId(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::module_id",
                arguments: _args,
            });
        }
        ...
        function nonce(tx, args) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::nonce",
                arguments: _args,
            });
        }
        builder.nonce = nonce;
        function pcrs(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::pcrs",
                arguments: _args,
            });
        }
        builder.pcrs = pcrs;
        function publicKey(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::public_key",
                arguments: _args,
            });
        }
        ...
        function timestamp(tx, args) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::timestamp",
                arguments: _args,
            });
        }
        builder.timestamp = timestamp;
        function userData(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::user_data",
                arguments: _args,
            });
        }
        builder.userData = userData;
        function value(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::nitro_attestation::value",
                arguments: _args,
            });
        }
        builder.value = value;
    })(builder = nitro_attestation.builder || (nitro_attestation.builder = {}));
    let view;
    (function (view) {
        ...
        view.index = index;
        async function moduleId(client, args) {
            const tx = new Transaction();
            builder.moduleId(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.nonce = nonce;
        async function pcrs(client, args) {
            const tx = new Transaction();
            builder.pcrs(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.pcrs = pcrs;
        async function publicKey(client, args) {
            const tx = new Transaction();
            builder.publicKey(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        async function userData(client, args) {
            const tx = new Transaction();
            builder.userData(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        async function value(client, args) {
            const tx = new Transaction();
            builder.value(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.value = value;
    })(view = nitro_attestation.view || (nitro_attestation.view = {}));
...
(function (object$) {
    ...
    (function (builder) {
        ...
        function suiAccumulatorRootAddress(tx, args) {
            const _args = [];
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::object::sui_accumulator_root_address",
                arguments: _args,
            });
        }
        builder.suiAccumulatorRootAddress = suiAccumulatorRootAddress;
        function suiAccumulatorRootObjectId(tx, args) {
            const _args = [];
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::object::sui_accumulator_root_object_id",
                arguments: _args,
            });
        }
    ...
    (function (view) {
        ...
        async function suiAccumulatorRootAddress(client, args) {
            const tx = new Transaction();
            builder.suiAccumulatorRootAddress(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.suiAccumulatorRootAddress = suiAccumulatorRootAddress;
        async function suiAccumulatorRootObjectId(client, args) {
            const tx = new Transaction();
            builder.suiAccumulatorRootObjectId(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
...
export class party extends SuiBaseProcessor {
    constructor(options) {
        super("party", options);
    }
    static DEFAULT_OPTIONS = {
    ...
    static bind(options = {}) {
        return new party({ ...party.DEFAULT_OPTIONS, ...options });
    }
    onEventParty(func, handlerOptions, eventFilter) {
        this.onMoveEvent(func, { ...(eventFilter ?? {}), type: "party::Party" }, handlerOptions);
        return this;
    }
    onEventPermissions(func, handlerOptions, eventFilter) {
        this.onMoveEvent(func, { ...(eventFilter ?? {}), type: "party::Permissions" }, handlerOptions);
        return this;
    }
}
(function (party) {
    let Party;
    (function (Party) {
        Party.TYPE_QNAME = "0x2::party::Party";
        const TYPE = new TypeDescriptor(Party.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        Party.type = type;
    ...
    (function (Permissions) {
        Permissions.TYPE_QNAME = "0x2::party::Permissions";
        const TYPE = new TypeDescriptor(Permissions.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        Permissions.type = type;
    })(Permissions = party.Permissions || (party.Permissions = {}));
    let builder;
    (function (builder) {
        function intoNative(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrPure(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::party::into_native",
                arguments: _args,
            });
        }
        builder.intoNative = intoNative;
        function isSingleOwner(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrObject(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::party::is_single_owner",
                arguments: _args,
            });
        }
        builder.isSingleOwner = isSingleOwner;
        function singleOwner(tx, args) {
            const _args = [];
            _args.push(transactionArgumentOrPureAddress(args[0], tx));
            // @ts-ignore
            return tx.moveCall({
        ...
        builder.singleOwner = singleOwner;
    })(builder = party.builder || (party.builder = {}));
    let view;
    (function (view) {
        async function intoNative(client, args) {
            const tx = new Transaction();
            builder.intoNative(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.intoNative = intoNative;
        async function isSingleOwner(client, args) {
            const tx = new Transaction();
            builder.isSingleOwner(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.isSingleOwner = isSingleOwner;
        async function singleOwner(client, args) {
            const tx = new Transaction();
            builder.singleOwner(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.singleOwner = singleOwner;
    })(view = party.view || (party.view = {}));
})(party || (party = {}));
...
(function (sui) {
    ...
    (function (SUI) {
        ...
        const TYPE = new TypeDescriptor(SUI.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
        SUI.type = type;
...
(function (transfer_1) {
    ...
    (function (builder) {
        ...
        function partyTransfer(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPure(args[0], tx));
            _args.push(transactionArgumentOrPure(args[1], tx));
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::transfer::party_transfer",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.partyTransfer = partyTransfer;
        function partyTransferImpl(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPure(args[0], tx));
            _args.push(transactionArgumentOrPureU64(args[1], tx));
            _args.push(transactionArgumentOrVec(args[2], tx));
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::transfer::party_transfer_impl",
                arguments: _args,
                typeArguments: [
                    typeof typeArguments[0] === "string"
                        ? typeArguments[0]
        ...
        builder.partyTransferImpl = partyTransferImpl;
        ...
        function publicPartyTransfer(tx, args, typeArguments) {
            const _args = [];
            _args.push(transactionArgumentOrPure(args[0], tx));
            _args.push(transactionArgumentOrPure(args[1], tx));
            // @ts-ignore
        ...
        builder.publicPartyTransfer = publicPartyTransfer;
    ...
    (function (view) {
        ...
        async function partyTransfer(client, args, typeArguments) {
            const tx = new Transaction();
            builder.partyTransfer(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.partyTransfer = partyTransfer;
        async function partyTransferImpl(client, args, typeArguments) {
            const tx = new Transaction();
            builder.partyTransferImpl(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.partyTransferImpl = partyTransferImpl;
        ...
        async function publicPartyTransfer(client, args, typeArguments) {
            const tx = new Transaction();
            builder.publicPartyTransfer(tx, args, typeArguments);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.publicPartyTransfer = publicPartyTransfer;
...
(function (tx_context) {
    ...
    (function (builder) {
        ...
        function gasPrice(tx, args) {
            ...
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::tx_context::gas_price",
                arguments: _args,
            });
        }
        builder.gasPrice = gasPrice;
        function referenceGasPrice(tx, args) {
            const _args = [];
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::tx_context::reference_gas_price",
                arguments: _args,
            });
        }
        builder.referenceGasPrice = referenceGasPrice;
        ...
        builder.sender = sender;
        function sponsor(tx, args) {
            const _args = [];
            // @ts-ignore
            return tx.moveCall({
                target: "0x2::tx_context::sponsor",
                arguments: _args,
            });
        }
    ...
    (function (view) {
        ...
        async function referenceGasPrice(client, args) {
            const tx = new Transaction();
            builder.referenceGasPrice(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
        ...
        view.referenceGasPrice = referenceGasPrice;
        ...
        view.sender = sender;
        async function sponsor(client, args) {
            const tx = new Transaction();
            builder.sponsor(tx, args);
            const inspectRes = await client.devInspectTransactionBlock({
                transactionBlock: tx,
                sender: ZERO_ADDRESS,
            });
