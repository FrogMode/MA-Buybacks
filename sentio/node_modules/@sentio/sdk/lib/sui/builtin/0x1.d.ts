...
export declare class bit_vector extends SuiBaseProcessor {
    ...
    onEventBitVector(func: (event: bit_vector.BitVectorInstance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, bit_vector.BitVectorInstance>, eventFilter?: Omit<EventFilter, "type" | "account">): bit_vector;
}
...
export declare class fixed_point32 extends SuiBaseProcessor {
    ...
    onEventFixedPoint32(func: (event: fixed_point32.FixedPoint32Instance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, fixed_point32.FixedPoint32Instance>, eventFilter?: Omit<EventFilter, "type" | "account">): fixed_point32;
}
...
export declare class string$ extends SuiBaseProcessor {
    ...
    onEventString(func: (event: string$.StringInstance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, string$.StringInstance>, eventFilter?: Omit<EventFilter, "type" | "account">): string$;
}
...
export declare class type_name extends SuiBaseProcessor {
    ...
    onEventTypeName(func: (event: type_name.TypeNameInstance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, type_name.TypeNameInstance>, eventFilter?: Omit<EventFilter, "type" | "account">): type_name;
}
...
export declare class uq32_32 extends SuiBaseProcessor {
    constructor(options: SuiBindOptions);
    static DEFAULT_OPTIONS: SuiBindOptions;
    static bind(options?: Partial<SuiBindOptions>): uq32_32;
    onEventUQ32_32(func: (event: uq32_32.UQ32_32Instance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, uq32_32.UQ32_32Instance>, eventFilter?: Omit<EventFilter, "type" | "account">): uq32_32;
}
...
export declare class uq64_64 extends SuiBaseProcessor {
    constructor(options: SuiBindOptions);
    static DEFAULT_OPTIONS: SuiBindOptions;
    static bind(options?: Partial<SuiBindOptions>): uq64_64;
    onEventUQ64_64(func: (event: uq64_64.UQ64_64Instance, ctx: SuiContext) => void, handlerOptions?: HandlerOptions<MoveFetchConfig, uq64_64.UQ64_64Instance>, eventFilter?: Omit<EventFilter, "type" | "account">): uq64_64;
}
