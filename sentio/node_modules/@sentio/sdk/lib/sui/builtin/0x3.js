...
import { transactionArgumentOrObject, transactionArgumentOrVec, transactionArgumentOrPure, transactionArgumentOrPureU8, transactionArgumentOrPureU16, transactionArgumentOrPureU64, transactionArgumentOrPureBool, transactionArgumentOrPureAddress, } from "@typemove/sui";
...
(function (stake_subsidy) {
    ...
    (function (builder) {
        ...
        function create(tx, args) {
            ...
            _args.push(transactionArgumentOrPureU16(args[3], tx));
            // @ts-ignore
            return tx.moveCall({
...
export class staking_pool extends SuiBaseProcessor {
    ...
    onEventUnderflowSuiBalance(func, handlerOptions, eventFilter) {
        this.onMoveEvent(func, { ...(eventFilter ?? {}), type: "staking_pool::UnderflowSuiBalance" }, handlerOptions);
        return this;
    }
}
(function (staking_pool) {
    ...
    (function (UnderflowSuiBalance) {
        ...
        const TYPE = new TypeDescriptor(UnderflowSuiBalance.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
...
(function (validator_set) {
    ...
    (function (VotingPowerAdmissionStartEpochKey) {
        ...
        const TYPE = new TypeDescriptor(VotingPowerAdmissionStartEpochKey.TYPE_QNAME);
        function type() {
            return TYPE.apply();
        }
