...
import { AbstractEntity as Entity, Bytes, Float, ID, Int, Timestamp, UpdateValues } from './types.js';
...
export declare function getEntityField<T>(entity: EntityClass<T> | T | string, field: string): string;
export declare class Store {
    private readonly context;
    constructor(context: IStoreContext);
    ...
    update<T extends Entity>(entity: EntityClass<T>, values: UpdateValues<any>): Promise<void>;
...
type CompatibleValue<T, O extends Operators<T>> = O extends ArrayOperators ? T extends Array<infer U> ? U[] : T[] : (T extends bigint ? bigint : T extends Int ? number : T extends Float ? number : T extends Bytes ? Bytes | string : T extends ID ? ID | string : T extends BigDecimal ? BigDecimal | number : T extends Int ? number : T extends () => Promise<any> ? ID | string : T) | Nullable<O>;
