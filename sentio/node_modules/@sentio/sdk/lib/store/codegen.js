...
export async function codegen(srcDir, outputDir) {
...
function isTimeseries(t) {
    return t.astNode?.directives?.some((d) => d.name.value == 'entity' &&
        d.arguments?.some((a) => a.name.value == 'timeseries' && a.value.kind == 'BooleanValue' && a.value.value == true));
}
function isImmutable(t) {
    return (t.astNode?.directives?.some((d) => d.name.value == 'entity' &&
        d.arguments?.some((a) => a.name.value == 'immutable' && a.value.kind == 'BooleanValue' && a.value.value == true)) || isTimeseries(t));
}
function isDerived(f) {
    return f.astNode?.directives?.some((d) => d.name.value == 'derivedFrom');
}
function getDerivedField(f) {
    return (f.astNode?.directives
