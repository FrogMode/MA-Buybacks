import { MetricValue, RichValue_NullValue } from '@sentio/protos';
import { BigDecimal } from './big-decimal.js';
export function toMetricValue(value) {
...
export function toBigDecimal(value) {
    const s = (value.c || [])
        .map((v, idx) => {
...
export function toTimeSeriesData(value, labels, neg) {
