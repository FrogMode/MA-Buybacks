import { moduleQname, SPLITTER, camel, normalizeToJSName, upperFirst } from '@typemove/move';
import { AbstractCodegen } from '@typemove/move/codegen';
export class SharedNetworkCodegen extends AbstractCodegen {
    // readonly ALL_NETWORKS: string[]
    NETWORK;
    networkIdToKey = new Map();
    network;
    constructor(network, chainAdapter) {
        super(chainAdapter);
...
//# sourceMappingURL=shared-network-codegen.js.map