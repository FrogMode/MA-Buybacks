...
export class SuiFacet {
    ...
    testEntryFunctionCall(transaction, network = SuiNetwork.MAIN_NET) {
        return this.testEntryFunctionCalls([transaction], network);
    }
    testEntryFunctionCalls(transactions, network = SuiNetwork.MAIN_NET) {
        const bindings = [];
    ...
    testGlobalTransaction(transaction, network = SuiNetwork.MAIN_NET) {
        const handlerIds = [];
        for (const config of this.server.contractConfigs) {
...
//# sourceMappingURL=sui-facet.js.map