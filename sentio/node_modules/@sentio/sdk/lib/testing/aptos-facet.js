...
export class AptosFacet {
    ...
    testEntryFunctionCall(transaction, network = AptosNetwork.MAIN_NET) {
        return this.testEntryFunctionCalls([transaction], network);
    }
    testEntryFunctionCalls(transactions, network = AptosNetwork.MAIN_NET) {
        const bindings = [];
    ...
    buildEntryFunctionCallBinding(transaction, network = AptosNetwork.MAIN_NET) {
...
//# sourceMappingURL=aptos-facet.js.map