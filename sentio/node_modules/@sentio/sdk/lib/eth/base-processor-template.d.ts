...
export declare abstract class BaseProcessorTemplate<TContract extends BaseContract, TBoundContractView extends BoundContractView<TContract, ContractView<TContract>>> {
    ...
    startInstance(options: Omit<BindOptions, 'network'>, ctx: EthContext): void;
    ...
    onTimeInterval(handler: (block: BlockParams, ctx: ContractContext<TContract, TBoundContractView>) => PromiseOrVoid, timeIntervalInMinutes?: number, backfillTimeIntervalInMinutes?: number, fetchConfig?: EthFetchConfig, preprocessHandler?: (block: BlockParams, ctx: ContractContext<TContract, TBoundContractView>, preprocessStore: {
        [k: string]: any;
    }) => Promise<PreprocessResult>): this;
