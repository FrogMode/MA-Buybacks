import { errorString, getProvider, GLOBAL_CONFIG, mergeProcessResults, Plugin, PluginManager, USER_PROCESSOR } from '@sentio/runtime';
...
export class EthPlugin extends Plugin {
    ...
    async start(request) {
        ...
        for (const instance of request.templateInstances) {
            ...
            const ctx = new NoopContext(instance.contract.chainId);
    ...
    async processTrace(binding, preparedData) {
    ...
    async processBlock(binding, preparedData) {
    ...
    async processTransaction(binding, preparedData) {
...
function mergePreprocessResults(results) {
    const res = { ethCallParams: [] };
