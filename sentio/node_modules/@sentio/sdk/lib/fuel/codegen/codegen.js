...
import { AbiTypeGen, ProgramTypeEnum } from '@fuel-ts/abi-typegen';
...
function genOnCallFunction(contractName, f) {
    const name = upperFirst(f.name);
    return `
...
function collectImportedTypes(types) {
    const ret = new Set();
...
function getLogConstants(logByTypes) {
...
function genOnLogFunction(contractName, [type, ids]) {
