...
export declare enum ExecutionConfig_HandlerOrderInsideTransaction {
    BY_LOG_INDEX = 0,
    BY_PROCESSOR_AND_LOG_INDEX = 1,
    UNRECOGNIZED = -1
}
export declare function executionConfig_HandlerOrderInsideTransactionFromJSON(object: any): ExecutionConfig_HandlerOrderInsideTransaction;
export declare function executionConfig_HandlerOrderInsideTransactionToJSON(object: ExecutionConfig_HandlerOrderInsideTransaction): string;
...
export declare enum ProcessStreamResponse_Partitions_Partition_SysValue {
    BLOCK_NUMBER = 0,
    SEQ_MODE = 1,
    UNIQUE_VALUE = 2,
    UNRECOGNIZED = -1
}
export declare function processStreamResponse_Partitions_Partition_SysValueFromJSON(object: any): ProcessStreamResponse_Partitions_Partition_SysValue;
export declare function processStreamResponse_Partitions_Partition_SysValueToJSON(object: ProcessStreamResponse_Partitions_Partition_SysValue): string;
...
export interface EntityUpdateData {
    fields: {
        [key: string]: EntityUpdateData_FieldValue;
    };
}
export declare enum EntityUpdateData_Operator {
    SET = 0,
    ADD = 1,
    MULTIPLY = 2,
    UNRECOGNIZED = -1
}
export declare function entityUpdateData_OperatorFromJSON(object: any): EntityUpdateData_Operator;
export declare function entityUpdateData_OperatorToJSON(object: EntityUpdateData_Operator): string;
...
export declare enum TimeseriesResult_TimeseriesType {
    EVENT = 0,
    GAUGE = 1,
    COUNTER = 2,
    UNRECOGNIZED = -1
}
export declare function timeseriesResult_TimeseriesTypeFromJSON(object: any): TimeseriesResult_TimeseriesType;
export declare function timeseriesResult_TimeseriesTypeToJSON(object: TimeseriesResult_TimeseriesType): string;
...
export declare const ExecutionConfig_DecoderWorkerConfig: {
...
export declare const ConfigureHandlersResponse: {
    encode(message: ConfigureHandlersResponse, writer?: _m0.Writer): _m0.Writer;
...
export declare const UpdateTemplatesRequest: {
    encode(message: UpdateTemplatesRequest, writer?: _m0.Writer): _m0.Writer;
...
export declare const FuelReceiptHandlerConfig: {
    encode(message: FuelReceiptHandlerConfig, writer?: _m0.Writer): _m0.Writer;
...
export declare const FuelReceiptHandlerConfig_Transfer: {
    encode(message: FuelReceiptHandlerConfig_Transfer, writer?: _m0.Writer): _m0.Writer;
...
export declare const FuelReceiptHandlerConfig_Log: {
    encode(message: FuelReceiptHandlerConfig_Log, writer?: _m0.Writer): _m0.Writer;
...
export declare const FuelTransactionHandlerConfig: {
    encode(message: FuelTransactionHandlerConfig, writer?: _m0.Writer): _m0.Writer;
...
export declare const ProcessStreamResponse_Partitions: {
    encode(message: ProcessStreamResponse_Partitions, writer?: _m0.Writer): _m0.Writer;
...
export declare const ProcessStreamResponse_Partitions_Partition: {
    encode(message: ProcessStreamResponse_Partitions_Partition, writer?: _m0.Writer): _m0.Writer;
    ...
    fromPartial(object: DeepPartial<ProcessStreamResponse_Partitions_Partition>): ProcessStreamResponse_Partitions_Partition;
};
export declare const ProcessStreamResponse_Partitions_PartitionsEntry: {
    encode(message: ProcessStreamResponse_Partitions_PartitionsEntry, writer?: _m0.Writer): _m0.Writer;
    ...
    create(base?: DeepPartial<ProcessStreamResponse_Partitions_PartitionsEntry>): ProcessStreamResponse_Partitions_PartitionsEntry;
    fromPartial(object: DeepPartial<ProcessStreamResponse_Partitions_PartitionsEntry>): ProcessStreamResponse_Partitions_PartitionsEntry;
};
export declare const ProcessStreamResponseV3: {
    encode(message: ProcessStreamResponseV3, writer?: _m0.Writer): _m0.Writer;
...
export declare const EntityUpdateData: {
    encode(message: EntityUpdateData, writer?: _m0.Writer): _m0.Writer;
...
export declare const EntityUpdateData_FieldValue: {
    encode(message: EntityUpdateData_FieldValue, writer?: _m0.Writer): _m0.Writer;
...
export declare const EntityUpdateData_FieldsEntry: {
    encode(message: EntityUpdateData_FieldsEntry, writer?: _m0.Writer): _m0.Writer;
...
export declare const TPLRequest: {
    encode(message: TPLRequest, writer?: _m0.Writer): _m0.Writer;
...
export declare const TSRequest: {
    encode(message: TSRequest, writer?: _m0.Writer): _m0.Writer;
...
export declare const DBRequest_DBUpdate: {
    encode(message: DBRequest_DBUpdate, writer?: _m0.Writer): _m0.Writer;
...
export declare const Data_FuelReceipt: {
...
export declare const Data_FuelTransaction: {
...
export declare const TimeseriesResult: {
...
export declare const ProcessorV3Definition: {
    readonly name: "ProcessorV3";
    readonly fullName: "processor.ProcessorV3";
    readonly methods: {
        readonly start: {
            readonly name: "Start";
            readonly requestType: {
        ...
        readonly updateTemplates: {
            readonly name: "UpdateTemplates";
            readonly requestType: {
                encode(message: UpdateTemplatesRequest, writer?: _m0.Writer): _m0.Writer;
                decode(input: _m0.Reader | Uint8Array, length?: number): UpdateTemplatesRequest;
                fromJSON(object: any): UpdateTemplatesRequest;
...
export interface ProcessorV3ServiceImplementation<CallContextExt = {}> {
    ...
    processBindingsStream(request: AsyncIterable<ProcessStreamRequest>, context: CallContext & CallContextExt): ServerStreamingMethodResult<DeepPartial<ProcessStreamResponseV3>>;
}
export interface ProcessorV3Client<CallOptionsExt = {}> {
    ...
    processBindingsStream(request: AsyncIterable<DeepPartial<ProcessStreamRequest>>, options?: CallOptions & CallOptionsExt): AsyncIterable<ProcessStreamResponseV3>;
}
