...
export declare function payMethodFromJSON(object: any): PayMethod;
export declare function payMethodToJSON(object: PayMethod): string;
...
export declare enum UsageTracker_CustomSkus_SkuOp {
    MIN = 0,
    SUM = 1,
    MAX = 2,
    UNRECOGNIZED = -1
}
export declare function usageTracker_CustomSkus_SkuOpFromJSON(object: any): UsageTracker_CustomSkus_SkuOp;
export declare function usageTracker_CustomSkus_SkuOpToJSON(object: UsageTracker_CustomSkus_SkuOp): string;
...
export declare const UsageTracker_SkuWithFieldValue: {
    encode(message: UsageTracker_SkuWithFieldValue, writer?: _m0.Writer): _m0.Writer;
...
export declare const UsageTracker_SkusByField: {
    encode(message: UsageTracker_SkusByField, writer?: _m0.Writer): _m0.Writer;
...
export declare const UsageTracker_CustomSkus: {
    encode(message: UsageTracker_CustomSkus, writer?: _m0.Writer): _m0.Writer;
...
export declare const Auth: {
    encode(message: Auth, writer?: _m0.Writer): _m0.Writer;
...
export declare const Auth_MetadataEntry: {
    encode(message: Auth_MetadataEntry, writer?: _m0.Writer): _m0.Writer;
...
export declare const CommunityProject: {
    encode(message: CommunityProject, writer?: _m0.Writer): _m0.Writer;
...
export declare const CommunityProject_ChainEntry: {
    encode(message: CommunityProject_ChainEntry, writer?: _m0.Writer): _m0.Writer;
